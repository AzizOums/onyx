...
import (
	...
	"github.com/lumen-dot-app/lumen/tools/ods/internal/lazyimports"
)
...
Examples:
  ...
  ods check-lazy-imports lumen/llm/           # Check only files in lumen/llm/
  ods check-lazy-imports lumen/chat/chat.py   # Check a specific file`,
