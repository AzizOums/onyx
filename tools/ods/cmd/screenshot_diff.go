...
import (
	...
	"github.com/lumen-dot-app/lumen/tools/ods/internal/imgdiff"
...
const (
	...
	DefaultS3Bucket = "lumen-playwright-artifacts"
...
The bucket defaults to "lumen-playwright-artifacts" and can be overridden
...
Examples:
  ...
  ods screenshot-diff upload-baselines \
    --dir ./web/output/screenshots/ \
    --dest s3://lumen-playwright-artifacts/baselines/admin/main/`,
		Run: func(cmd *cobra.Command, args []string) {
