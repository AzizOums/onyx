...
// off it (e.g. `ods release opal`) and cut releases of Lumen-published
...
func NewReleaseCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "release",
		Short: "Cut releases of Lumen-published packages",
		Long: `Cut releases of Lumen-published packages.
