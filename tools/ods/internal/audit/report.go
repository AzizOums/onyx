...
func runbook(res *Result) string {
	...
	add += ` --reason "<why this is not exploitable in Lumen>"`
	...
	b.WriteString("  - Accept: if you've reviewed an advisory and it isn't exploitable in Lumen,\n")
...
const (
	...
	sarifVersion = "2.1.0"
	sarifToolURI = "https://github.com/lumen-dot-app/lumen"
)
