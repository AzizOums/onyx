"""Locust entrypoint for Lumen chat load tests.
...
README "Worker concurrency sweep"). LUMEN_SHAPE=stepramp drives a staged ramp.
...
from lumen_client.chat_user import BasicChatUser
...
if os.environ.get("LUMEN_SHAPE") == "stepramp":
