...
/**
 * Lumen Chat Widget - Component Styles
 * All styling for the main widget component
 */
export const widgetStyles = css`
  :host {
    display: block;
    font-family: var(--lumen-font-family);
  }
  ...
  .container {
    ...
    height: 600px;
    background: var(--background-neutral-00);
    border-radius: var(--lumen-radius-16);
    box-shadow: var(--shadow-02);
    display: flex;
    flex-direction: column;
    overflow: hidden;
    z-index: var(--lumen-z-widget);
  ...
  .container.inline {
    ...
    width: 100%;
    height: 100%;
    border-radius: var(--lumen-radius-08);
    animation: none;
    opacity: 1;
    transform: none;
  }
  ...
  .header-title {
    font-weight: 600;
    font-size: var(--lumen-font-size-label);
    line-height: var(--lumen-line-height-label);
    color: var(--text-04);
  }
  ...
  .icon-button {
    ...
    color: var(--text-04);
    cursor: pointer;
    padding: var(--lumen-space-xs);
    border-radius: var(--lumen-radius-08);
    display: flex;
    align-items: center;
    justify-content: center;
    transition:
      background var(--lumen-transition-fast),
  ...
  .message-bubble {
    ...
    border-radius: var(--lumen-radius-12);
    word-wrap: break-word;
    font-size: var(--lumen-font-size-main);
    line-height: var(--lumen-line-height-main);
  }

  .message.user .message-bubble {
    background: var(--lumen-user-message-bg);
    color: var(--text-04);
    border: 1px solid var(--border-01);
  }

  .message.assistant .message-bubble {
    background: var(--lumen-assistant-message-bg);
    color: var(--text-04);
    border: 1px solid var(--border-01);
  }
  ...
  .message-bubble blockquote {
    ...
    margin: 0.5em 0;
    padding-left: var(--lumen-space-md);
    color: var(--text-04);
  }
  ...
  .status-text {
    color: var(--text-04);
    font-size: var(--lumen-font-size-sm);
    font-style: italic;
  }
  ...
  .input-container {
    padding: var(--lumen-space-md) var(--lumen-space-md) 4px;
    display: flex;
    align-items: center;
    gap: var(--lumen-space-xs);
  }
  ...
  .input {
    flex: 1;
    min-width: 0;
    padding: var(--lumen-space-xs) var(--lumen-space-sm);
    ...
    color: var(--text-04);
    transition:
      border-color var(--lumen-transition-fast),
  ...
  .powered-by {
    ...
    opacity: 0.5;
    text-align: center;
    padding: 0 var(--lumen-space-md) var(--lumen-space-xs);
  }

  .powered-by a {
    color: var(--text-04);
    text-decoration: none;
    transition: opacity var(--lumen-transition-fast);
  }
  ...
  .disclaimer {
    padding: var(--lumen-space-xs) var(--lumen-space-md);
    background: var(--background-neutral-00);
    color: var(--text-04);
    font-size: 11px;
    line-height: 1.3;
  ...
  .compact-input-container {
    ...
    box-shadow: var(--shadow-02);
    transition:
      border-color var(--lumen-transition-base),
      box-shadow var(--lumen-transition-base);
  }
