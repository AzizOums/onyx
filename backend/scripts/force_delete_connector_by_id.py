...
from lumen.db.document import delete_documents_complete__no_commit
from lumen.db.enums import ConnectorCredentialPairStatus
...
from lumen.db.document import get_documents_for_connector_credential_pair
...
def _delete_connector(cc_pair_id: int, db_session: Session) -> None:
    user_input = input(
        ...
        IT MAY CAUSE ISSUES with your Lumen instance! \
