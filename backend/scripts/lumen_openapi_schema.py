...
def generate_client(openapi_json_path: str, strip_tags: bool = True) -> None:
    ...
    output_dir = os.path.join(os.path.dirname(openapi_json_path), "lumen_openapi_client")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Export OpenAPI schema for Lumen API (does not require starting API server)"
    )
    parser.add_argument(
