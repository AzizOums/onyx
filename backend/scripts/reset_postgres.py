...
from lumen.configs.app_configs import (  # noqa: E402
    POSTGRES_DB,
    POSTGRES_HOST,
    POSTGRES_PASSWORD,
    POSTGRES_PORT,
...
from lumen.db.credentials import create_initial_public_credential  # noqa: E402
...
if __name__ == "__main__":
    print("Cleaning up all Lumen tables")
    ...
    print(
        "To be safe, it's best to restart the Lumen services (API Server and Background Tasks"
    )
