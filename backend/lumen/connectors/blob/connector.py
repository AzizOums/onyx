...
from lumen.configs.app_configs import BLOB_STORAGE_SIZE_THRESHOLD, INDEX_BATCH_SIZE
from lumen.configs.constants import BlobType, DocumentSource, FileOrigin
            ...
            if authentication_method == "access_key":
                ...
                def _refresh_credentials() -> dict[str, str]:
                    ...
                    assumed_role_object = sts_client.assume_role(
                        RoleArn=role_arn,
                        RoleSessionName=f"lumen_blob_storage_{int(time.time())}",
                    )
    ...
    def _yield_blob_objects(
        ...
        for page in pages:
            ...
            for obj in page["Contents"]:
                ...
                # Handle image files
                if file_ext in LumenFileExtensions.IMAGE_EXTENSIONS:
                ...
                try:
                    ...
                    lumen_metadata, custom_tags = process_lumen_metadata(
                        extraction_result.metadata
                    )
                    file_display_name = lumen_metadata.file_display_name or file_name
                    time_updated = lumen_metadata.doc_updated_at or last_modified
                    ...
                    source_type = lumen_metadata.source_type or DocumentSource(
