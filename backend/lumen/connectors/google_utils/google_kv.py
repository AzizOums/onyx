...
from lumen.connectors.google_utils.resources import get_drive_service, get_gmail_service
...
from lumen.db.credentials import fetch_credential_by_id_for_user, update_credential_json
...
from lumen.server.documents.models import CredentialBase, GoogleServiceAccountKey
...
def update_credential_access_tokens(
    ...
    try:
        ...
        if MISSING_SCOPES_ERROR_STR in str(e):
            raise LumenError(
                LumenErrorCode.INSUFFICIENT_PERMISSIONS, LUMEN_SCOPE_INSTRUCTIONS
            ) from e
        raise e
