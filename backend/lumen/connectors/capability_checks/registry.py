...
from lumen.connectors.capability_checks.applicability import (
...
from lumen.connectors.slack.capability_checks import build_slack_indexing_checks
from lumen.connectors.source_operations import get_source_operations_class
...
def get_capability_checks(source: DocumentSource) -> list[CapabilityCheck]:
    ...
    get_perm_sync_checks = fetch_ee_implementation_or_noop(
        "lumen.connectors.capability_checks",
