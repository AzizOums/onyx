...
_STATUS_TO_ERROR_CODE: dict[int, LumenErrorCode] = {
    401: LumenErrorCode.CREDENTIAL_EXPIRED,
    403: LumenErrorCode.INSUFFICIENT_PERMISSIONS,
    404: LumenErrorCode.BAD_GATEWAY,
}


def _error_code_for_status(status_code: int) -> LumenErrorCode:
    """Map an HTTP status code to the appropriate LumenErrorCode.
    ...
    return LumenErrorCode.BAD_GATEWAY
