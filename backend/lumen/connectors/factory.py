...
from lumen.connectors.credentials_provider import build_db_credentials_provider
from lumen.connectors.exceptions import ConnectorValidationError, ValidationError
...
from lumen.connectors.registry import CONNECTOR_CLASS_MAP
from lumen.db.connector import fetch_connector_by_id
from lumen.db.credentials import backend_update_credential_json, fetch_credential_by_id
from lumen.db.enums import AccessType, CapabilityCheckTrigger
from lumen.db.models import Credential
from lumen.file_store.staging import RawFileCallback
from lumen.utils.credential_audit import emit_credential_access
...
def instantiate_connector(
    ...
    if isinstance(connector, CredentialsConnector):
        ...
        if credential.credential_json:
            # Distinct decrypt site from LumenDBCredentialsProvider (static /
