...
from lumen.connectors.slack.models import MessageType
...
# gateway's ``fetch_user_info`` operation satisfies this; lumenbot (which keeps
    ...
    def _get_slack_name(self, user_id: str) -> str:
        if user_id not in self._id_to_name_map:
            try:
                ...
                # the display name (LUMEN-BACKEND-H6FN).
                logger.warning(
