...
from lumen.configs.constants import INDEX_SEPARATOR, RETURN_SEPARATOR, DocumentSource
from lumen.db.enums import HierarchyNodeType, IndexModelStatus
from lumen.utils.text_processing import make_url_compatible
...
class DocumentBase(BaseModel):
    """Used for Lumen ingestion api, the ID is inferred before use if not provided"""
...
class Document(DocumentBase):
    """Used for Lumen ingestion api, the ID is required"""
