<!-- LUMEN_METADATA={"link": "https://github.com/lumen-dot-app/lumen/blob/main/backend/lumen/connectors/README.md"} -->

# Writing a new Lumen Connector

This README covers how to contribute a new Connector for Lumen. It includes an overview of the design, interfaces,
...
Refer to [interfaces.py](https://github.com/lumen-dot-app/lumen/blob/main/backend/lumen/connectors/interfaces.py)
and this first contributor created Pull Request for a new connector (Shoutout to Dan Brown):
[Reference Pull Request](https://github.com/lumen-dot-app/lumen/pull/139)

For implementing a Slim Connector, refer to the comments in this PR:
[Slim Connector PR](https://github.com/lumen-dot-app/lumen/pull/3303/files)
...
> Note: Be sure to set PYTHONPATH to lumen/backend before running the above main.
...
- Add a new type to
  [DocumentSource](https://github.com/lumen-dot-app/lumen/blob/main/backend/lumen/configs/constants.py)
- Add a mapping from DocumentSource (and optionally connector type) to the right connector class
  [here](https://github.com/lumen-dot-app/lumen/blob/main/backend/lumen/connectors/factory.py#L33)

#### Frontend Changes

- Add the new Connector definition to the `SOURCE_METADATA_MAP` [here](https://github.com/lumen-dot-app/lumen/blob/main/web/src/lib/sources.ts#L59).
- Add the definition for the new Form to the `connectorConfigs` object [here](https://github.com/lumen-dot-app/lumen/blob/main/web/src/lib/connectors/connectors.ts#L79).

#### Docs Changes

Create the new connector page (with guiding images!) with how to get the connector credentials and how to set up the
connector in Lumen. Then create a Pull Request in [https://github.com/lumen-dot-app/documentation](https://github.com/lumen-dot-app/documentation).
