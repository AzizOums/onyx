...
from lumen.configs.app_configs import CONNECTOR_LOCALHOST_OVERRIDE
from lumen.configs.constants import IGNORE_FOR_QA, DocumentSource
from lumen.connectors.models import BasicExpertInfo, LumenMetadata
from lumen.utils.datetime import datetime_to_utc
from lumen.utils.logger import setup_logger
from lumen.utils.text_processing import is_valid_email
...
def process_lumen_metadata(
    metadata: dict[str, Any],
) -> tuple[LumenMetadata, dict[str, Any]]:
    """
    Users may set Lumen metadata and custom tags in text files. https://docs.lumen.app/admins/connectors/official/file
