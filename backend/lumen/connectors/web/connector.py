...
from lumen.configs.app_configs import INDEX_BATCH_SIZE, REQUEST_TIMEOUT_SECONDS
...
from lumen.connectors.models import Document, HierarchyNode, SlimDocument, TextSection
from lumen.file_processing.html_utils import web_html_cleanup
from lumen.indexing.indexing_heartbeat import IndexingHeartbeatInterface
from lumen.server.security.models import web_connector_ssrf_enforced
...
# patch these names on `lumen.connectors.web.connector`.
from lumen.utils.playwright_fetch import (
    DEFAULT_HEADERS,
    DEFAULT_USER_AGENT,  # noqa: F401
    start_playwright,
)
from lumen.utils.sitemap import list_pages_for_site
from lumen.utils.web_content import extract_pdf_text, is_pdf_resource
        ...
        try:
            ...
            if not slim and self.scroll_before_scraping:
                try:
                    ...
                    # (LUMEN-BACKEND-H6G5). Skip auto-scroll in that case and
...
if __name__ == "__main__":
    connector = WebConnector("https://docs.lumen.app/")
