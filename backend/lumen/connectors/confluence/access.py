...
def get_page_restrictions(
    ...
    ee_get_all_page_restrictions = cast(
        Callable[
            [LumenConfluence, str, dict[str, Any], list[dict[str, Any]], bool],
            ExternalAccess | None,
        ],
        fetch_versioned_implementation(
            "lumen.external_permissions.confluence.page_access", "get_page_restrictions"
        ),
    )
...
def get_page_restrictions_with_per_ancestor_fetch(
    ...
    ee_get_per_ancestor = cast(
        ...
        fetch_versioned_implementation(
            "lumen.external_permissions.confluence.page_access",
...
def get_all_space_permissions(
    ...
    ee_get_all_space_permissions = cast(
        Callable[
            [LumenConfluence, bool, bool],
            dict[str, ExternalAccess],
        ],
        fetch_versioned_implementation(
            "lumen.external_permissions.confluence.space_access",
