...
from lumen.connectors.confluence.models import ConfluenceUser
from lumen.connectors.confluence.user_profile_override import (
    process_confluence_user_profiles_override,
)
from lumen.connectors.confluence.utils import (
    _handle_http_error,
    confluence_refresh_tokens,
    get_start_param_from_url,
    update_param_in_path,
)
from lumen.connectors.cross_connector_utils.miscellaneous_utils import scoped_url
from lumen.connectors.exceptions import (
    ConnectorValidationError,
    InsufficientPermissionsError,
)
from lumen.connectors.interfaces import CredentialsProviderInterface
from lumen.file_processing.html_utils import format_document_soup
...
class LumenConfluence:
    ...
    def _initialize_connection_helper(
        ...
        **kwargs: Any,
        ...
        if "confluence_refresh_token" in credentials:
            ...
            oauth2_dict: dict[str, Any] = LumenConfluence._make_oauth2_dict(credentials)
    ...
    def get_server_version(self) -> tuple[int, int] | None:
        ...
        Probed once per LumenConfluence instance via Atlassian's
...
def get_user_email_from_username__server(
    confluence_client: LumenConfluence, user_name: str
) -> str | None:
...
def get_user_email_from_userkey__server(
    confluence_client: LumenConfluence, user_key: str
) -> str | None:
...
def _get_user(confluence_client: LumenConfluence, user_id: str) -> str:
...
def extract_text_from_confluence_html(
    confluence_client: LumenConfluence,
