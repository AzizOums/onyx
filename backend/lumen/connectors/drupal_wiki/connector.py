...
from lumen.connectors.cross_connector_utils.rate_limit_wrapper import (
    rate_limit_builder,
    rl_requests,
)
...
from lumen.connectors.drupal_wiki.models import (
    DrupalWikiCheckpoint,
    DrupalWikiPage,
    DrupalWikiPageResponse,
    DrupalWikiSpaceResponse,
)
from lumen.connectors.drupal_wiki.utils import build_drupal_wiki_document_id
...
class DrupalWikiConnector(
        ...
        **kwargs: Any,
        ...
        if deprecated_found:
            raise ConnectorValidationError(
                ...
                f"Please delete and recreate this connector, or contact Lumen support "
    ...
    def _validate_attachment_filetype(self, attachment: dict[str, Any]) -> bool:
        ...
        if file_extension in LumenFileExtensions.ALL_ALLOWED_EXTENSIONS:
            return True
