...
from lumen.connectors.salesforce.auth import (
    build_salesforce_client,
    exchange_salesforce_authorization_code,
)
from lumen.connectors.salesforce.doc_conversion import (
    ID_PREFIX,
    convert_sf_object_to_doc,
    convert_sf_query_result_to_doc,
)
from lumen.connectors.salesforce.models import SalesforceMyDomainUrl
from lumen.connectors.salesforce.lumen_salesforce import LumenSalesforce
from lumen.connectors.salesforce.salesforce_calls import fetch_all_csvs_in_parallel
...
class SalesforceConnector(
    ...
    def __init__(
        ...
        self._sf_client: LumenSalesforce | None = None
    ...
    @property
    def sf_client(self) -> LumenSalesforce:
    ...
    def _load_csvs_to_db(
        csv_directory: str, remove_ids: bool, sf_db: LumenSalesforceSQLite
    ) -> dict[str, str]:
        """
        ...
        # from import lumen.connectors.salesforce.sf_db.sqlite_functions find_ids_by_type
    ...
    #     parent_types: list[str], sf_client: LumenSalesforce
    # ) -> set[str]:
    ...
    def _full_sync(
        ...
        sf_db = LumenSalesforceSQLite(os.path.join(temp_dir, "salesforce_db.sqlite"))
        sf_db.connect()
    ...
    def _make_context(
        ...
        for parent_type in parent_types:
            # parent_lumen_sf_type = LumenSalesforceType(parent_type, sf_client)
        ...
        for sf_type in all_types:
            # lumen_sf_type = LumenSalesforceType(sf_type, sf_client)
