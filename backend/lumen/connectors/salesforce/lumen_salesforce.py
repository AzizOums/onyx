...
from lumen.connectors.cross_connector_utils.rate_limit_wrapper import rate_limit_builder
from lumen.connectors.salesforce.blacklist import (
    SALESFORCE_BLACKLISTED_OBJECTS,
    SALESFORCE_BLACKLISTED_PREFIXES,
    SALESFORCE_BLACKLISTED_SUFFIXES,
)
from lumen.connectors.salesforce.models import SalesforceSessionCredentials
from lumen.connectors.salesforce.salesforce_calls import get_object_by_id_query
from lumen.connectors.salesforce.utils import ID_FIELD, validate_sf_identifier
...
class LumenSalesforce(Salesforce):
    ...
    def get_child_objects_by_id(
        ...
        while True:
            ...
            if len(child_relationships_batch) >= LumenSalesforce.SOQL_MAX_SUBQUERIES:
                process_batch = True
            ...
            if process_batch:
                ...
                query = LumenSalesforce._make_child_objects_by_id_query(
                    object_id,
                    sf_type,
