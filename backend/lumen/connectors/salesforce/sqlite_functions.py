    ...
    def _apply_schema_impl(self) -> None:
        ...
        with self._conn:
            ...
            if cursor.fetchone()[0] == 0:
                LumenSalesforceSQLite._update_user_email_map(cursor)
            elapsed = time.monotonic() - start
            logger.info(
            ...
            with open(csv_download_path, "r", newline="", encoding="utf-8") as f:
                ...
                for row in reader:
                    ...
                    normalized_record, parent_ids = (
                        LumenSalesforceSQLite.normalize_record(row, remove_ids)
                    )
                    ...
                    LumenSalesforceSQLite._update_relationship_tables(
