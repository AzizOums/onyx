...
from lumen.auth.login_claims_capture import IDP_PLACEHOLDER_KEYS
...
from lumen.prompts.constants import CODE_BLOCK_PAT, REMINDER_TAG_DESCRIPTION
...
def apply_prompt_placeholders(
    ...
    *,
    ...
    """Apply standard Lumen prompt placeholders to any prompt string.
