...
Run as ``python -m lumen.utils.isolated_runner`` so it works even when the caller is
...
def main() -> None:
    ...
    from lumen.utils.process_isolation import STATUS_EXC, STATUS_OK, STATUS_UNRELAYABLE
