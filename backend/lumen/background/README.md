# Overview of Lumen Background Jobs
...
Watchdog is a separate Python process managed by supervisord which runs alongside celery workers. It checks the LUMEN_CELERY_BEAT_HEARTBEAT_KEY in
