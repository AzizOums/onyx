import lumen.background.celery.configs.base as shared_config
from lumen.configs.app_configs import CELERY_WORKER_SCHEDULED_TASKS_CONCURRENCY
...
# can be long-running, so we use threads (consistent with every other Lumen
