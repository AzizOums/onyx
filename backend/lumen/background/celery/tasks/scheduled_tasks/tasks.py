...
from lumen.server.features.build.scheduled_tasks.executor import (
...
@shared_task(  # ty: ignore[invalid-argument-type]
    name=LumenCeleryTask.SCHEDULED_TASKS_DISPATCH_DUE,
    ignore_result=True,
    bind=True,
)
...
@shared_task(  # ty: ignore[invalid-argument-type]
    name=LumenCeleryTask.SCHEDULED_TASKS_RUN,
    ignore_result=True,
...
@shared_task(  # ty: ignore[invalid-argument-type]
    name=LumenCeleryTask.SCHEDULED_TASKS_CLEANUP_STUCK,
    ignore_result=True,
    bind=True,
)
