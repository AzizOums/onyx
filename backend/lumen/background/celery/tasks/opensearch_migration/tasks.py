...
from lumen.background.celery.tasks.opensearch_migration.constants import (
...
from lumen.background.celery.tasks.opensearch_migration.transformer import (
...
from lumen.configs.constants import LumenCeleryTask, LumenRedisLocks
from lumen.db.engine.sql_engine import get_session_with_current_tenant
from lumen.db.opensearch_migration import (
...
@shared_task(  # ty: ignore[invalid-argument-type]
    name=LumenCeleryTask.MIGRATE_CHUNKS_FROM_VESPA_TO_OPENSEARCH_TASK,
...
def migrate_chunks_from_vespa_to_opensearch_task(
    ...
    *,
    ...
    if not ENABLE_OPENSEARCH_INDEXING_FOR_LUMEN:
        task_logger.warning(
    ...
    lock: RedisLock = r.lock(
        name=LumenRedisLocks.OPENSEARCH_MIGRATION_BEAT_LOCK,
