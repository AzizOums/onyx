...
from lumen.access.access import get_access_for_document
...
from lumen.background.celery.tasks.shared.tasks import (
    ...
    LIGHT_TIME_LIMIT,
    LumenCeleryTaskCompletionStatus,
)
...
from lumen.configs.app_configs import JOB_TIMEOUT, VESPA_SYNC_MAX_TASKS
...
from lumen.db.enums import SyncStatus, SyncType
from lumen.db.models import DocumentSet, UserGroup
...
from lumen.db.user_group_crud import (
    delete_user_group,
    fetch_user_groups,
    fetch_user_group,
...
@shared_task(  # ty: ignore[invalid-argument-type]
    name=LumenCeleryTask.CHECK_FOR_VESPA_SYNC_TASK,
    ignore_result=True,
...
def check_for_vespa_sync_task(self: Task, *, tenant_id: str) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        LumenRedisLocks.CHECK_VESPA_SYNC_BEAT_LOCK,
...
@shared_task(  # ty: ignore[invalid-argument-type]
    name=LumenCeleryTask.DOCUMENT_INDEX_METADATA_SYNC_TASK,
    bind=True,
...
def document_index_metadata_sync_task(
    ...
    *,
    ...
    completion_status = LumenCeleryTaskCompletionStatus.UNDEFINED
    ...
    try:
        ...
        if update_request is None:
            ...
            completion_status = LumenCeleryTaskCompletionStatus.SKIPPED
        else:
            ...
            completion_status = LumenCeleryTaskCompletionStatus.SUCCEEDED
    except SoftTimeLimitExceeded:
        task_logger.info(f"SoftTimeLimitExceeded exception. doc={document_id}")
        completion_status = LumenCeleryTaskCompletionStatus.SOFT_TIME_LIMIT
        ...
        while True:
            ...
            if isinstance(e, httpx.HTTPStatusError):
                ...
                completion_status = (
                    LumenCeleryTaskCompletionStatus.NON_RETRYABLE_EXCEPTION
                )
                break
            ...
            completion_status = LumenCeleryTaskCompletionStatus.RETRYABLE_EXCEPTION
            if (
    ...
    return completion_status == LumenCeleryTaskCompletionStatus.SUCCEEDED
