...
from lumen.server.features.build.configs import SANDBOX_IDLE_TIMEOUT_SECONDS
...
from lumen.server.features.build.session.locks import get_session_creation_lock
...
@shared_task(  # ty: ignore[invalid-argument-type]
    name=LumenCeleryTask.CLEANUP_IDLE_SANDBOXES,
