...
from lumen.configs.app_configs import JOB_TIMEOUT
...
from lumen.db.connector import fetch_connector_by_id
...
from lumen.db.document_set import delete_document_set_cc_pair_relationship__no_commit
...
from lumen.db.hierarchy import cleanup_unowned_hierarchy_nodes
from lumen.db.index_attempt import delete_index_attempts, get_recent_attempts_for_cc_pair
...
from lumen.db.port_attempt import get_active_port_attempt, request_port_cancel
from lumen.db.search_settings import get_all_search_settings
from lumen.db.sync_record import (
    cleanup_sync_records,
    insert_sync_record,
    update_sync_record_status,
)
from lumen.db.tag import delete_orphan_tags__no_commit
from lumen.redis.redis_connector import RedisConnector
from lumen.redis.redis_connector_delete import (
    RedisConnectorDelete,
    RedisConnectorDeletePayload,
)
from lumen.redis.redis_hierarchy import invalidate_hierarchy_cache_for_source
...
@shared_task(  # ty: ignore[invalid-argument-type]
    name=LumenCeleryTask.CHECK_FOR_CONNECTOR_DELETION,
    ignore_result=True,
...
def check_for_connector_deletion_task(self: Task, *, tenant_id: str) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        LumenRedisLocks.CHECK_CONNECTOR_DELETION_BEAT_LOCK,
    ...
    try:
        ...
        lock_beat.reacquire()
        if not r.exists(LumenRedisSignals.BLOCK_VALIDATE_CONNECTOR_DELETION_FENCES):
            ...
            r.set(LumenRedisSignals.BLOCK_VALIDATE_CONNECTOR_DELETION_FENCES, 1, ex=300)
