...
from lumen.connectors.capability_checks.models import compute_connector_config_hash
...
@shared_task(  # ty: ignore[invalid-argument-type]
    name=LumenCeleryTask.RUN_CAPABILITY_CHECKS,
    bind=True,
)
...
@shared_task(  # ty: ignore[invalid-argument-type]
    name=LumenCeleryTask.CHECK_FOR_STALE_CAPABILITY_RUNS,
    bind=True,
)
