...
@shared_task(  # ty: ignore[invalid-argument-type]
    name=LumenCeleryTask.EVAL_RUN_TASK,
    ignore_result=True,
...
@shared_task(  # ty: ignore[invalid-argument-type]
    name=LumenCeleryTask.SCHEDULED_EVAL_TASK,
    ignore_result=True,
...
def scheduled_eval_task(self: Task, **kwargs: Any) -> None:  # noqa: ARG001
    ...
    - SCHEDULED_EVAL_PERMISSIONS_EMAIL: Email for search permissions (default: roshan@lumen.app)
