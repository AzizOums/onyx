...
from lumen.background.celery.celery_utils import make_probe_path
from lumen.background.celery.tasks.beat_schedule import CLOUD_BEAT_MULTIPLIER_DEFAULT
from lumen.configs.constants import POSTGRES_CELERY_BEAT_APP_NAME
...
celery_app.config_from_object("lumen.background.celery.configs.beat")
    ...
    def _generate_schedule(
        ...
        if MULTI_TENANT:
            ...
            get_cloud_tasks_to_schedule = fetch_versioned_implementation(
                "lumen.background.celery.tasks.beat_schedule",
        ...
        get_tasks_to_schedule = fetch_versioned_implementation(
            "lumen.background.celery.tasks.beat_schedule", "get_tasks_to_schedule"
        )
