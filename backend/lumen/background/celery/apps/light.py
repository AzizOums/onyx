...
from lumen.configs.constants import POSTGRES_CELERY_WORKER_LIGHT_APP_NAME
...
celery_app.config_from_object("lumen.background.celery.configs.light")
...
celery_app.autodiscover_tasks(
    app_base.filter_task_modules(
        [
            ...
            "lumen.background.celery.tasks.build",
        ]
    )
)
