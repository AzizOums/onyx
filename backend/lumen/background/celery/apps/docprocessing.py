...
from lumen.background.celery.tasks.docprocessing.batch_counters import (
    on_docprocessing_task_postrun,
    on_docprocessing_task_prerun,
)
from lumen.configs.constants import POSTGRES_CELERY_WORKER_DOCPROCESSING_APP_NAME
...
celery_app.config_from_object("lumen.background.celery.configs.docprocessing")
