...
from lumen.access.access import source_should_fetch_permissions_during_indexing
from lumen.background.indexing.checkpointing_utils import (
    check_checkpoint_size,
    get_latest_valid_checkpoint,
    save_checkpoint,
)
from lumen.background.indexing.memory_tracer import MemoryTracer
...
from lumen.connectors.interfaces import CheckpointedConnector
...
from lumen.db.connector_alerts import notify_admins_of_connector_alert
from lumen.db.connector_credential_pair import (
    get_connector_credential_pair_from_id,
    get_last_successful_attempt_poll_range_end,
    update_connector_credential_pair,
)
from lumen.db.constants import CONNECTOR_VALIDATION_ERROR_MESSAGE_PREFIX
...
from lumen.db.hierarchy import persist_hierarchy_nodes_for_cc_pair
...
from lumen.db.models import Connector, Credential, IndexAttempt
...
from lumen.utils.postgres_sanitization import (
...
def connector_document_extraction(
    ...
    with get_session_with_current_tenant() as db_session:
        ...
        docprocessing_priority = (
            LumenCeleryPriority.MEDIUM
            if has_successful_attempt
            else LumenCeleryPriority.HIGH
        )
        ...
        while checkpoint.has_more:
            ...
            for (
                ...
                with time_stage(IndexAttemptStage.DOC_BATCH_ENQUEUE, index_attempt_id):
                    ...
                    app.send_task(
                        LumenCeleryTask.DOCPROCESSING_TASK,
                        kwargs=processing_batch_data,
                        queue=LumenCeleryQueues.DOCPROCESSING,
