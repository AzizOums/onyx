...
from lumen.db.targeted_reindex import targets_to_connector_failures
...
from lumen.utils.postgres_sanitization import sanitize_hierarchy_nodes_for_postgres
...
def _flush_batch(
    *,
    ...
    metadata = IndexAttemptMetadata(
        ...
        request_id=make_randomized_lumen_request_id("TRX"),
