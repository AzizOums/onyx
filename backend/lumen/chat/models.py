...
from lumen.tools.models import SearchToolUsage, ToolCallKickoff
from lumen.tools.tool_implementations.custom.base_tool_types import ToolResultType
...
class ChatLoadedFile(InMemoryChatFile):
    ...
    def lazy_loaded(
        ...
        *,
        ...
        """
        from lumen.file_store.models import install_lazy_content_loader
