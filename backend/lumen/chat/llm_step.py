...
from lumen.chat.citation_processor import DynamicCitationProcessor
from lumen.chat.emitter import Emitter
from lumen.chat.incognito import current_turn_persists_content
from lumen.chat.models import ChatMessageSimple, LlmStepResult
from lumen.chat.tool_call_args_streaming import maybe_emit_argument_delta
...
from lumen.llm.model_response import Delta
...
from lumen.llm.request_context import get_llm_request_params
...
from lumen.tools.tool_name import sanitize_tool_name
from lumen.tracing.flows import LLMFlow
from lumen.tracing.framework.create import generation_span
from lumen.tracing.llm_utils import build_llm_model_config
from lumen.utils.b64 import get_image_type_from_bytes
from lumen.utils.jsonriver import Parser
from lumen.utils.logger import setup_logger
from lumen.utils.postgres_sanitization import sanitize_string
from lumen.utils.text_processing import find_all_json_objects
...
def run_llm_step_pkt_generator(
    ...
    if LOG_LUMEN_MODEL_INTERACTIONS and current_turn_persists_content():
        logger.debug(
            "Message history:\n%s",
