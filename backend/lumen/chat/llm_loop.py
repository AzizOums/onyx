...
from lumen.chat.citation_utils import update_citation_processor_from_tool_response
from lumen.chat.emitter import Emitter
from lumen.chat.llm_step import (
...
from lumen.chat.prompt_utils import (
    build_reminder_message,
    build_system_prompt,
    get_default_base_system_prompt,
    process_prompt_template,
)
from lumen.configs.app_configs import INTEGRATION_TESTS_MODE
from lumen.configs.chat_configs import MAX_LLM_CYCLES
from lumen.configs.constants import DocumentSource, MessageType
from lumen.configs.model_configs import GEN_AI_INPUT_TOKEN_SAFETY_MARGIN
from lumen.context.search.models import SearchDoc, SearchDocsResponse
from lumen.db.engine.sql_engine import get_session_with_current_tenant
from lumen.db.memory import UserMemoryContext, add_memory, update_memory_at_index
...
from lumen.llm.exceptions import ClassifiedLLMError
from lumen.llm.interfaces import LLM, LLMUserIdentity, ToolChoiceOptions
from lumen.llm.model_capabilities import is_true_openai_model
from lumen.llm.models import ReasoningEffort
from lumen.llm.utils import model_supports_image_input
from lumen.prompts.chat_prompts import (
    IMAGE_GEN_REMINDER,
...
from lumen.tools.built_in_tools import CITEABLE_TOOLS_NAMES, STOPPING_TOOLS_NAMES
from lumen.tools.interface import Tool
from lumen.tools.models import (
...
from lumen.tools.tool_implementations.images.models import FinalImageGenerationResponse
...
from lumen.tools.utils import compute_all_tool_tokens
from lumen.tracing.framework.create import ChatTraceMetadata, trace
...
def run_llm_loop(
    ...
    with trace(
        ...
        from lumen.llm.litellm_singleton.config import (
            initialize_litellm,
