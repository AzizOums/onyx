...
from lumen.chat.incognito_context import incognito_context_available
...
from lumen.db.kg_config import (
...
from lumen.db.models import SearchDoc as DbSearchDoc
from lumen.db.persona import user_can_access_persona
from lumen.db.projects import check_project_ownership
from lumen.db.user_file import get_user_file_by_id
...
from lumen.file_store.models import ChatFileType, FileDescriptor
from lumen.file_store.utils import plaintext_file_name_for_id, store_plaintext
from lumen.kg.models import KGException
from lumen.kg.setup.kg_default_entity_definitions import (
...
from lumen.prompts.tool_prompts import TOOL_CALL_FAILURE_PROMPT
from lumen.server.query_and_chat.models import ChatSessionCreationRequest
from lumen.server.query_and_chat.streaming_models import CitationInfo
from lumen.tools.models import ChatFile, ToolCallKickoff
...
def create_chat_session_from_request(
    ...
    if chat_session_request.incognito:
        if not incognito_context_available():
            raise LumenError(
                LumenErrorCode.DEPLOYMENT_UNSUPPORTED,
