...
from lumen.file_processing.extract_file_text import xlsx_sheet_extraction
from lumen.file_processing.file_types import SPREADSHEET_MIME_TYPES, LumenMimeTypes
...
def mime_type_to_chat_file_type(mime_type: str | None) -> ChatFileType:
    ...
    if normalized_mime_type in LumenMimeTypes.IMAGE_MIME_TYPES:
    ...
    if normalized_mime_type in LumenMimeTypes.TABULAR_MIME_TYPES:
        return ChatFileType.TABULAR

    if normalized_mime_type in LumenMimeTypes.DOCUMENT_MIME_TYPES:
