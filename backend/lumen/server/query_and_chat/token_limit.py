...
from lumen.configs.constants import TokenRateLimitScope
from lumen.db.engine.sql_engine import get_session_with_current_tenant
from lumen.db.models import TokenRateLimit, User
from lumen.db.token_limit import fetch_all_global_token_rate_limits
...
def check_token_rate_limits(
    ...
    versioned_rate_limit_strategy = fetch_versioned_implementation(
        "lumen.server.query_and_chat.token_limit", _check_token_rate_limits.__name__
    )
...
def _token_budget_reset(
    ...
    for rate_limit in rate_limits:
        ...
        # The admin enters the budget in THOUSANDS of tokens (Lumen convention),
