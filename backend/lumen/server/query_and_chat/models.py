...
from lumen.configs.constants import DocumentSource, MessageType, SessionType
from lumen.context.search.models import BaseFilters, SavedSearchDoc, SearchDoc, Tag
from lumen.db.enums import ChatSessionSharedStatus
from lumen.db.models import ChatSession
from lumen.file_store.models import FileDescriptor
from lumen.llm.override_models import LLMOverride
from lumen.server.query_and_chat.streaming_models import Packet
...
class UpdateChatSessionThreadRequest(BaseModel):
    # If not specified, use Lumen default persona
...
# NOTE: This model is used for the core flow of the Lumen application, any changes to it should be reviewed and approved by an
