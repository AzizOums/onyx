...
from lumen.access.access import user_can_access_chat_file
...
from lumen.background.task_utils import enqueue_user_file_deletes
from lumen.cache.factory import get_cache_backend
from lumen.chat.chat_processing_checker import (
    get_processing_run_id,
    is_chat_session_processing,
)
from lumen.chat.chat_state import ChatStateContainer
...
from lumen.chat.incognito_context import teardown_incognito_session
from lumen.chat.models import ChatFullResponse, CreateChatSessionID
from lumen.chat.process_message import (
    gather_stream_full,
    handle_multi_model_stream,
    handle_stream_message_objects,
)
from lumen.chat.prompt_utils import get_default_base_system_prompt
from lumen.chat.stop_signal_checker import set_fence
from lumen.chat.stream_buffer import has_stream_buffer, read_stream_chunks
from lumen.configs.app_configs import WEB_DOMAIN
from lumen.configs.chat_configs import (
...
from lumen.configs.model_configs import LITELLM_PASS_THROUGH_HEADERS
...
from lumen.db.chat_search import search_chat_sessions
from lumen.db.engine.sql_engine import get_session, get_session_with_current_tenant
from lumen.db.enums import Permission, record_mode_persists_content
from lumen.db.feedback import create_chat_message_feedback, remove_chat_message_feedback
from lumen.db.incognito import (
    is_incognito_teardown_target,
    mark_incognito_user_files_deleting,
)
from lumen.db.llm import fetch_default_chat_naming_model
from lumen.db.models import ChatMessage, ChatSessionSharedStatus, Persona, User
from lumen.db.persona import get_persona_by_id
from lumen.db.usage import UsageType, increment_usage
from lumen.db.user_file import get_file_id_by_user_file_id
...
from lumen.secondary_llm_flows.chat_session_naming import (
    DEFAULT_CHAT_SESSION_NAME,
    generate_chat_session_name,
    get_fallback_chat_session_name,
)
from lumen.server.api_key_usage import check_api_key_usage
...
from lumen.server.query_and_chat.session_loading import (
    translate_assistant_message_to_packets,
)
from lumen.server.query_and_chat.streaming_models import Packet, heartbeat_packet
from lumen.server.query_and_chat.token_limit import check_token_rate_limits
from lumen.server.usage_limits import (
    check_llm_cost_limit_for_provider,
    check_usage_and_raise,
    is_usage_limits_enabled,
)
from lumen.server.utils import get_json_line
from lumen.tracing.framework.create import ChatTraceMetadata, ensure_trace
from lumen.utils.headers import get_custom_tool_additional_request_headers
...
def handle_send_chat_message(
    ...
    # Streaming path, normal Lumen UI behavior
...
def fetch_chat_file(
    ...
    if not user_can_access_chat_file(file_id, user, db_session):
        ...
        raise LumenError(LumenErrorCode.NOT_FOUND, "File not found")
...
def stop_chat_session(
    ...
    try:
        ...
        raise LumenError(LumenErrorCode.SESSION_NOT_FOUND, "Chat session not found")
