...
class LumenJSONEncoder(json.JSONEncoder):
...
def get_json_line(
    json_dict: dict[str, Any], encoder: type[json.JSONEncoder] = LumenJSONEncoder
) -> str:
    """
    ...
    Args:
        ...
        encoder: JSON encoder class to use, defaults to LumenJSONEncoder.
