...
from lumen.configs.constants import DEFAULT_CC_PAIR_ID, PUBLIC_API_TAGS
...
from lumen.server.lumen_api.models import (
    DocMinimalInfo,
    IngestionDocument,
    IngestionResult,
)
...
router = APIRouter(prefix="/lumen-api", tags=PUBLIC_API_TAGS)
...
def delete_ingestion_doc(
    ...
    if document is None:
        raise LumenError(LumenErrorCode.DOCUMENT_NOT_FOUND, "Document not found")
