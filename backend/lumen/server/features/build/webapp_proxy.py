...
from lumen.db.enums import Permission, SharingScope
...
from lumen.server.features.build.sandbox.nextjs_dev import webapp_base_path
...
# prevent LLM-generated apps from setting cookies on the parent Lumen domain.
EXCLUDED_HEADERS = {
    "content-encoding",
    "content-length",
    "transfer-encoding",
...
# LLM-generated webapp code and must never receive the viewer's Lumen
