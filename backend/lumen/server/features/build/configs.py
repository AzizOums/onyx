...
SANDBOX_NAMESPACE = os.environ.get("SANDBOX_NAMESPACE", "lumen-sandboxes")

SANDBOX_CONTAINER_IMAGE = (
    os.environ.get("SANDBOX_CONTAINER_IMAGE", "").strip() or "lumendotapp/sandbox:latest"
)
...
SANDBOX_PUSH_PRIVATE_KEY = os.environ.get("LUMEN_SANDBOX_PUSH_PRIVATE_KEY", "")


LUMEN_GATEWAY_PROVIDER_ID = "lumen"
...
# Complete Lumen API base URL reachable from the sandbox, including any path
# prefix. Must be set when SANDBOX_BACKEND=kubernetes.
LUMEN_SERVER_URL = os.environ.get("LUMEN_SERVER_URL", "")
...
# mounts).
SANDBOX_PROXY_NAMESPACE = os.environ.get("SANDBOX_PROXY_NAMESPACE", "lumen")
...
# Non-empty sentinel for every proxy-injected credential (LUMEN_PAT + each
...
MCP_SESSION_TAG_HEADER = "X-Lumen-Mcp-Session"
...
SANDBOX_DOCKER_NETWORK = os.environ.get("SANDBOX_DOCKER_NETWORK", "lumen_craft_sandbox")

SANDBOX_DOCKER_VOLUME_PREFIX = os.environ.get(
    "SANDBOX_DOCKER_VOLUME_PREFIX", "lumen-craft-sandbox-"
)
...
TURN_BUDGET_FILE_NAME = ".lumen-turn-budget.json"
