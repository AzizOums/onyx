...
from lumen.db.enums import ApprovalDecidedVia, ApprovalDecision, GatedAppKind, Permission
from lumen.db.models import ActionApproval, User
...
def submit_decision(
    ...
    if current is None:
        raise LumenError(LumenErrorCode.NOT_FOUND, "approval request not found")
