"""Lumen's internal sandbox-event schema.

Single import point for the typed events Lumen's sandbox layer emits and
...
# Lumen-synthesized ``Error.code`` sentinels for turn-terminating failures.
