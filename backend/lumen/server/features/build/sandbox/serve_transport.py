...
from lumen.cache.interface import CACHE_TRANSIENT_ERRORS, CacheLock, CacheLockLostError
...
from lumen.server.features.build.sandbox.opencode.serve_client import (
    OpencodeServeClient,
    _TurnState,
