...
from lumen.server.features.build.configs import SANDBOX_PUSH_PRIVATE_KEY
...
from lumen.server.features.build.sandbox.models import FilesystemEntry
...
def get_push_key_pair() -> tuple[Ed25519PrivateKey, str]:
    ...
    if not SANDBOX_PUSH_PRIVATE_KEY:
        raise RuntimeError("LUMEN_SANDBOX_PUSH_PRIVATE_KEY is not set")
    ...
    try:
        ...
        raise RuntimeError(
            "LUMEN_SANDBOX_PUSH_PRIVATE_KEY is not a valid base64-encoded "
