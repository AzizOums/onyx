...
from lumen.server.features.build.configs import TURN_BUDGET_FILE_NAME
...
from lumen.server.features.build.sandbox.serve_transport import _ServeMixin
...
class SandboxManager(_ServeMixin, ABC):
    ...
    def provision(
        ...
        Args:
            ...
            lumen_pat: Raw PAT token to inject as LUMEN_PAT env var in the sandbox
