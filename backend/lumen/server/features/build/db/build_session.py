...
from lumen.db.enums import BuildSessionStatus, SessionOrigin, SharingScope
from lumen.db.models import BuildMessage, BuildSession, Sandbox
...
from lumen.utils.postgres_sanitization import sanitize_json_like
...
def reserve_nextjs_port__no_commit(
    ...
    Raises:
        LumenError: If no ports are available in the configured range
    """
    allocated_ports = {
        port
