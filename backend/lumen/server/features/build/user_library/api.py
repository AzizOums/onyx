...
from lumen.db.connector_credential_pair import update_connector_credential_pair
from lumen.db.engine.sql_engine import get_session
from lumen.db.enums import ConnectorCredentialPairStatus, Permission
...
from lumen.server.features.build.utils import sanitize_filename as api_sanitize_filename
...
async def upload_zip(
    ...
    try:
        ...
        raise LumenError(LumenErrorCode.INVALID_INPUT, "Invalid zip file")
