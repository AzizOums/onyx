...
from lumen.server.gateway.configs import GATEWAY_PATH_PREFIX
from lumen.server.gateway.model_catalog import (
...
class GatewaySelection:
    ...
    def to_columns(self) -> tuple[str, str]:
        ...
        return LUMEN_GATEWAY_PROVIDER_ID, self.wire_id
...
def build_lumen_gateway_config(
    ...
    api_root = LUMEN_SERVER_URL.rstrip("/")
    ...
    return CraftLLMProviderConfig(
        provider=LUMEN_GATEWAY_PROVIDER_ID,
