...
Custom Lumen packet types layered on top of the sandbox-event schema
(:mod:`sandbox.event_schema`). Sandbox events pass through directly from
the agent; this module only contains Lumen-specific extensions like
...
Custom Lumen packets (defined here):
- error: Lumen-specific errors (e.g., session not found)
...
class BasePacket(BaseModel):
    """Base packet with common fields for all custom Lumen packet types."""
...
# =============================================================================
# Custom Lumen Packets
# =============================================================================


class ErrorPacket(BasePacket):
    """An Lumen-specific error occurred (e.g., session not found, sandbox not running)."""
...
# =============================================================================
# Union Type for Custom Lumen Packets
# =============================================================================
