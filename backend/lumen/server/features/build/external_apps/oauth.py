...
from lumen.db.models import ExternalApp, User
...
from lumen.external_apps.providers.registry import get_provider_or_raise
from lumen.external_apps.token_utils import stamp_expires_at
...
from lumen.skills.push import push_skills_for_users
...
def handle_external_app_oauth_callback(
    ...
    try:
        ...
        raise LumenError(LumenErrorCode.INVALID_INPUT, "Malformed OAuth state.")
