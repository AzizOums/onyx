...
from lumen.db.enums import NotificationSeverity, Permission
...
from lumen.server.features.build.utils import ensure_build_mode_intro_notification
from lumen.server.features.notifications.models import (
...
from lumen.server.features.release_notes.utils import (
...
def _ensure_license_expiry_notification(user: User, db_session: Session) -> bool:
    ...
    try:
        fetch_ee_implementation_or_noop(
            "lumen.utils.license_notifications",
