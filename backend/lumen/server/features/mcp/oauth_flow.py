...
from lumen.db.enums import MCPTransport
...
from lumen.server.features.mcp.client import initialize_mcp_client
from lumen.server.features.mcp.client_metadata import mcp_oauth_redirect_uri
...
async def _start_auto_discovery_oauth_flow_once(
    ...
    try:
        async with asyncio.timeout(OAUTH_HTTP_TIMEOUT_SECONDS):
            ...
            except (ExceptionGroup, LumenError):
                raise
