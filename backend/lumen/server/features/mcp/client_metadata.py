...
from lumen.configs.constants import LUMEN_DEFAULT_APPLICATION_NAME, PUBLIC_API_TAGS
from lumen.server.features.mcp.models import MCPOAuthClientMetadataDocument
...
def build_mcp_oauth_client_metadata() -> MCPOAuthClientMetadataDocument:
    return MCPOAuthClientMetadataDocument(
        ...
        client_name=LUMEN_DEFAULT_APPLICATION_NAME,
