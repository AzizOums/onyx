...
from lumen.auth.constants import BEARER_PREFIX
from lumen.configs.app_configs import DISABLE_METRICS_AUTH, METRICS_AUTH_TOKEN
...
def verify_metrics_token(request: Request) -> None:
    ...
    and any missing/invalid token raises ``LumenError(UNAUTHENTICATED)``. The token
