"""Prometheus metrics setup for the Lumen API server.
...
from lumen.server.metrics.postgres_connection_pool import pool_timeout_handler
...
def setup_prometheus_metrics(app: Starlette) -> None:
    """Initialize HTTP request metrics for the Lumen API server.
