...
from lumen.configs.constants import LumenCeleryQueues
...
_QUEUE_LABEL_MAP: dict[str, str] = {
    LumenCeleryQueues.PRIMARY: "primary",
    LumenCeleryQueues.DOCPROCESSING: "docprocessing",
    LumenCeleryQueues.CONNECTOR_DOC_FETCHING: "docfetching",
    LumenCeleryQueues.VESPA_METADATA_SYNC: "vespa_metadata_sync",
    LumenCeleryQueues.CONNECTOR_DELETION: "connector_deletion",
    LumenCeleryQueues.CONNECTOR_PRUNING: "connector_pruning",
    LumenCeleryQueues.CONNECTOR_DOC_PERMISSIONS_SYNC: "permissions_sync",
    LumenCeleryQueues.CONNECTOR_EXTERNAL_GROUP_SYNC: "external_group_sync",
    LumenCeleryQueues.DOC_PERMISSIONS_UPSERT: "permissions_upsert",
    LumenCeleryQueues.CONNECTOR_HIERARCHY_FETCHING: "hierarchy_fetching",
    LumenCeleryQueues.LLM_MODEL_UPDATE: "llm_model_update",
    LumenCeleryQueues.CHECKPOINT_CLEANUP: "checkpoint_cleanup",
    LumenCeleryQueues.INDEX_ATTEMPT_CLEANUP: "index_attempt_cleanup",
    LumenCeleryQueues.CSV_GENERATION: "csv_generation",
    LumenCeleryQueues.CAPABILITY_CHECKS: "capability_checks",
    LumenCeleryQueues.USER_FILE_PROCESSING: "user_file_processing",
    LumenCeleryQueues.USER_FILE_PROJECT_SYNC: "user_file_project_sync",
    LumenCeleryQueues.USER_FILE_DELETE: "user_file_delete",
    LumenCeleryQueues.MONITORING: "monitoring",
    LumenCeleryQueues.SANDBOX: "sandbox",
    LumenCeleryQueues.OPENSEARCH_MIGRATION: "opensearch_migration",
}

# Queues where prefetched (unacked) task counts are meaningful
_UNACKED_QUEUES: list[str] = [
    LumenCeleryQueues.CONNECTOR_DOC_FETCHING,
    LumenCeleryQueues.DOCPROCESSING,
]
...
class QueueDepthCollector(_CachedCollector):
    ...
    def _collect_fresh(self) -> list[GaugeMetricFamily]:
        ...
        queue_age = GaugeMetricFamily(
            "lumen_queue_oldest_task_age_seconds",
...
class WorkerHealthCollector(_CachedCollector):
    ...
    def _collect_fresh(self) -> list[GaugeMetricFamily]:
        ...
        active_workers = GaugeMetricFamily(
            "lumen_celery_active_worker_count",
