...
from lumen.server.metrics.celery_task_metrics import _MAX_START_TIME_AGE_SECONDS
...
INDEXING_TASK_DURATION = Histogram(
    "lumen_indexing_task_duration_seconds",
