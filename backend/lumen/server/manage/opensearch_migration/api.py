...
from lumen.configs.app_configs import LUMEN_DISABLE_VESPA
...
from lumen.server.manage.opensearch_migration.models import (
...
def get_opensearch_retrieval_status(
    ...
    return OpenSearchRetrievalStatusResponse(
        ...
        toggling_retrieval_is_disabled=LUMEN_DISABLE_VESPA,
    )
