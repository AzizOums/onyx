...
from lumen.db.models import ChannelConfig, User
from lumen.db.persona import get_persona_by_id
from lumen.db.slack_bot import (
    fetch_slack_bot,
    fetch_slack_bots,
    insert_slack_bot,
    remove_slack_bot,
...
from lumen.lumenbot.slack.config import validate_channel_name
...
from lumen.server.manage.validate_tokens import (
    validate_app_token,
    validate_bot_token,
    validate_user_token,
)
...
def _form_channel_config(
    ...
    if (
        ...
        raise ValueError(
            "Cannot set LumenBot to respond to users in a private (ephemeral) message "
...
def create_bot(
    ...
    mt_cloud_telemetry(
        ...
        event=MilestoneRecordType.CREATED_LUMEN_BOT,
    )
