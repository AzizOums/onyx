...
from lumen.llm.constants import DYNAMIC_LLM_PROVIDERS
...
if TYPE_CHECKING:
    ...
    from lumen.db.models import ModelConfiguration as ModelConfigurationModel
...
def normalize_extra_headers(
    ...
    if not isinstance(value, dict):
        raise LumenError(LumenErrorCode.BAD_REQUEST, "extra_headers must be an object.")
