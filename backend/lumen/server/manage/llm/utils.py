...
def is_reasoning_model(model_id: str, display_name: str) -> bool:
    ...
    TODO: unify with model_is_reasoning_model (lumen/llm/model_capabilities.py)
...
def filter_model_configurations(
    ...
    from lumen.llm.well_known_providers.llm_provider_options import is_obsolete_model
...
def fetch_openai_compatible_model_ids(
    ...
    the caller owns capability filtering. Raises LumenError on failure.
    """
