...
from lumen.db.image_generation import (
...
from lumen.db.llm import remove_llm_provider
from lumen.db.models import LLMProvider as LLMProviderModel
from lumen.db.models import ModelConfiguration, User
from lumen.error_handling.error_codes import LumenErrorCode
from lumen.error_handling.exceptions import LumenError
from lumen.image_gen.exceptions import ImageProviderCredentialsError
from lumen.image_gen.factory import get_image_generation_provider, validate_credentials
...
from lumen.llm.utils import collect_credential_values, litellm_exception_to_safe_error
from lumen.server.manage.image_generation.models import (
    AvailableImageModel,
...
from lumen.server.manage.llm.utils import fetch_openai_compatible_model_ids
...
def test_image_generation(
    ...
    try:
        ...
        raise LumenError(LumenErrorCode.VALIDATION_ERROR, safe_error.message)
