...
from lumen.redis.redis_pool import WsTokenRateLimitExceeded, store_ws_token
from lumen.server.manage.models import VoiceSettingsUpdateRequest
from lumen.server.manage.voice.text_utils import strip_markdown_for_tts
from lumen.utils.logger import setup_logger
from lumen.voice.factory import get_voice_provider
...
async def transcribe_audio(
    ...
    try:
        ...
        raise LumenError(LumenErrorCode.INTERNAL_ERROR, str(exc)) from exc
    ...
    try:
        ...
        raise LumenError(
            LumenErrorCode.NOT_IMPLEMENTED,
...
async def synthesize_speech(
    ...
    try:
        ...
        raise LumenError(LumenErrorCode.INTERNAL_ERROR, "TTS provider returned no audio")
    except Exception as exc:
        raise LumenError(
            LumenErrorCode.BAD_GATEWAY, _extract_provider_error(exc)
        ) from exc
