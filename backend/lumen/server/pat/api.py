...
def delete_token(
    ...
    if not success:
        raise LumenError(LumenErrorCode.NOT_FOUND, "Token not found or not owned by user")
    db_session.commit()
