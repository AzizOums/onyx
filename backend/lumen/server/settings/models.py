...
class UserSettings(Settings):
    ...
    # Feature flag for Lumen Craft (Build Mode) - used for server-side redirects
    lumen_craft_enabled: bool = False
    ...
    lumen_craft_available: bool = False
    ...
    # Application version, read from the LUMEN_VERSION env var at startup.
