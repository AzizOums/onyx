...
from lumen.connectors.capability_checks.models import CredentialCapabilityReport
from lumen.connectors.capability_checks.runner import (
...
from lumen.db.credentials import (
...
from lumen.db.enums import CapabilityCheckTrigger, CapabilityReportRunStatus, Permission
from lumen.db.models import CredentialCapabilityReportRow, User
...
def trigger_capability_check(
    ...
    if credential is None:
        raise LumenError(
            LumenErrorCode.CREDENTIAL_NOT_FOUND,
    ...
    try:
        client_app.send_task(
            LumenCeleryTask.RUN_CAPABILITY_CHECKS,
            kwargs=dict(
                credential_id=credential_id,
                connector_id=request.connector_id,
            ...
            queue=LumenCeleryQueues.CAPABILITY_CHECKS,
