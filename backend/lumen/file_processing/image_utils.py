...
from lumen.connectors.models import ImageSection, TabularSection, TextSection
from lumen.file_processing.file_types import LumenMimeTypes
...
def make_image_callback(
    ...
    def _store_embedded_image(img_data: bytes, img_name: str) -> None:
        ...
        if img_mime in LumenMimeTypes.EXCLUDED_IMAGE_TYPES:
            logger.debug(
