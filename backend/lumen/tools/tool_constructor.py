...
from lumen.auth.oauth_token_manager import OAuthTokenManager
from lumen.chat.emitter import Emitter
from lumen.configs.app_configs import DISABLE_VECTOR_DB
from lumen.configs.model_configs import GEN_AI_TEMPERATURE
from lumen.context.search.models import BaseFilters, PersonaSearchInfo
from lumen.db.engine.sql_engine import get_session_with_current_tenant_if_none
from lumen.db.mcp import (
    get_all_mcp_tools_for_server,
    get_mcp_server_by_id,
)
from lumen.db.models import Persona, User
from lumen.db.models import Tool as ToolDBModel
from lumen.db.oauth_config import get_oauth_config
...
from lumen.image_gen.interfaces import ImageGenerationProviderCredentials
from lumen.llm.interfaces import LLM, LLMConfig
from lumen.lumenbot.slack.models import SlackContext
from lumen.server.features.mcp.credentials import (
    MCPCredentialsError,
    resolve_mcp_credentials,
)
from lumen.tools.built_in_tools import get_built_in_tool_by_id
from lumen.tools.interface import Tool
from lumen.tools.models import DynamicSchemaInfo, SearchToolUsage
from lumen.tools.tool_implementations.custom.custom_tool import (
    build_custom_tools_from_openapi_schema_and_headers,
)
from lumen.tools.tool_implementations.file_reader.file_reader_tool import FileReaderTool
from lumen.tools.tool_implementations.images.image_generation_tool import (
    ImageGenerationTool,
)
from lumen.tools.tool_implementations.mcp.mcp_tool import MCPTool
from lumen.tools.tool_implementations.memory.memory_tool import MemoryTool
...
from lumen.utils.headers import header_dict_to_header_list
...
def _get_image_generation_config(llm: LLM, db_session: Session) -> LLMConfig:
    ...
    from lumen.db.image_generation import get_default_image_generation_config
        ...
        if db_tool_model.in_code_tool_id:
            ...
            # Handle Web Search Tool
                ...
                try:
                    ...
                    raise ValueError(
                        "Internet search tool requires a search provider API key, please contact your Lumen admin to get it added!"
                    )
            ...
            # Handle Open URL Tool
                ...
                try:
                    ...
                    raise ValueError(
                        "Open URL tool requires a web content provider, please contact your Lumen admin to get it configured!"
                    )
