...
from lumen.configs.app_configs import IMAGE_MODEL_NAME, IMAGE_MODEL_PROVIDER
...
from lumen.image_gen.factory import get_image_generation_provider
from lumen.image_gen.generation import (
    generate_images_with_provider,
    is_image_generation_configured,
    resolve_image_size,
)
from lumen.image_gen.interfaces import (
...
from lumen.tools.models import ToolCallException, ToolExecutionException, ToolResponse
from lumen.tools.tool_implementations.images.models import (
