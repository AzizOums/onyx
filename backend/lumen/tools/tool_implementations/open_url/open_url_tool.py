...
from lumen.db.document import fetch_document_ids_by_links, filter_existing_document_ids
from lumen.db.engine.sql_engine import get_session_with_current_tenant
from lumen.db.models import User
from lumen.document_index.interfaces_new import DocumentIndex, DocumentSectionRequest
...
from lumen.tools.models import OpenURLToolOverrideKwargs, ToolCallException, ToolResponse
from lumen.tools.tool_implementations.open_url.models import (
    FailedFetch,
    WebContentProvider,
)
from lumen.tools.tool_implementations.open_url.url_normalization import (
...
from lumen.utils.url import normalize_url as normalize_web_content_url
    ...
    def __init__(
        ...
        Args:
            ...
            content_provider: Optional content provider. If not provided,
                ...
                to the built-in Lumen web crawler.
        ...
        if content_provider is not None:
            ...
            if provider is None:
                raise RuntimeError(
                    ...
                    "built-in Lumen web crawler can be initialized."
                )
