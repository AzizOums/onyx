...
from lumen.db.models import InternetSearchProvider
from lumen.db.web_search import (
    fetch_active_web_content_provider,
    fetch_active_web_search_provider,
)
from lumen.tools.tool_implementations.open_url.firecrawl import FirecrawlClient
from lumen.tools.tool_implementations.open_url.models import WebContentProvider
from lumen.tools.tool_implementations.open_url.lumen_web_crawler import (
    DEFAULT_MAX_HTML_SIZE_BYTES,
    DEFAULT_MAX_PDF_SIZE_BYTES,
    LumenWebCrawler,
)
from lumen.tools.tool_implementations.open_url.tavily import TavilyExtractClient
from lumen.tools.tool_implementations.web_search.clients.brave_client import BraveClient
from lumen.tools.tool_implementations.web_search.clients.exa_client import ExaClient
from lumen.tools.tool_implementations.web_search.clients.google_pse_client import (
    GooglePSEClient,
)
from lumen.tools.tool_implementations.web_search.clients.searxng_client import (
    SearXNGClient,
)
from lumen.tools.tool_implementations.web_search.clients.serper_client import (
    SerperClient,
)
from lumen.tools.tool_implementations.web_search.clients.tavily_client import (
    TavilyClient,
)
from lumen.tools.tool_implementations.web_search.models import (
    DEFAULT_MAX_RESULTS,
...
def build_content_provider_from_config(
    *,
    ...
    if provider_type == WebContentProviderType.LUMEN_WEB_CRAWLER:
        if config.timeout_seconds is not None:
            return LumenWebCrawler(
