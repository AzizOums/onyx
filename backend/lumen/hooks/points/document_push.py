...
from lumen.indexing.document_push import DocumentPushPayload, DocumentPushResponse
...
class DocumentPushSpec(HookPointSpec):
    ...
    The payload/response models are owned by lumen.indexing.document_push — the
    ...
    docs_url = (
        "https://docs.lumen.app/admins/advanced_configs/hook_extensions#document-push"
    )
