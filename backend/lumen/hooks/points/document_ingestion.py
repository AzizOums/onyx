...
from lumen.db.enums import HookFailStrategy, HookPoint
from lumen.hooks.points.base import HookPointSpec
...
class DocumentIngestionPayload(BaseModel):
    ...
    source: str = Field(
        description=(
            ...
            "Full list of values: https://github.com/lumen-dot-app/lumen/blob/main/backend/lumen/configs/constants.py#L195"
        )
    )
...
class DocumentIngestionSpec(HookPointSpec):
    ...
    Call site: immediately after Lumen's internal validation and before the
    ...
    docs_url = "https://docs.lumen.app/admins/advanced_configs/hook_extensions#document-ingestion"
