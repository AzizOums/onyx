...
from lumen.hooks.points.document_ingestion import DocumentIngestionSpec
from lumen.hooks.points.document_push import DocumentPushSpec
from lumen.hooks.points.query_processing import QueryProcessingSpec
...
def validate_registry() -> None:
    ...
    if missing:
        raise RuntimeError(
            ...
            "Add an entry to lumen.hooks.registry._REGISTRY."
        )
