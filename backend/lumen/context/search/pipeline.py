...
from lumen.context.search.forced_document_set import get_forced_document_set_names
...
from lumen.context.search.retrieval.search_runner import search_chunks
from lumen.context.search.utils import inference_section_from_chunks
...
from lumen.natural_language_processing.english_stopwords import strip_stopwords
...
def search_pipeline(
    ...
    censored_chunks: list[InferenceChunk] = fetch_ee_implementation_or_noop(
        "lumen.external_permissions.post_query_censoring",
