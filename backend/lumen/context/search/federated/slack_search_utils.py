...
from lumen.configs.app_configs import MAX_SLACK_QUERY_EXPANSIONS
from lumen.context.search.federated.models import ChannelMetadata, DirectThreadFetch
from lumen.context.search.models import ChunkIndexRequest
...
from lumen.natural_language_processing.english_stopwords import ENGLISH_STOPWORDS_SET
from lumen.lumenbot.slack.models import ChannelType
from lumen.prompts.federated_search import (
...
def extract_slack_message_urls(
    ...
    Parses URLs like:
      https://lumen-company.slack.com/archives/C097NBWMY8Y/p1775491616524769
