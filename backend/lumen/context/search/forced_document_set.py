...
When ``FORCED_DOCUMENT_SET_NAMES`` is set, the Lumen Search UI is hard-restricted to
...
from lumen.configs.app_configs import FORCED_DOCUMENT_SET_NAMES
from lumen.db.document_set import get_document_sets_by_name
