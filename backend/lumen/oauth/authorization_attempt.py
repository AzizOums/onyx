...
from lumen.oauth.models import AuthorizationAttempt, PayloadT
...
def _invalid_attempt_error() -> LumenError:
    return LumenError(LumenErrorCode.INVALID_INPUT, _INVALID_ATTEMPT_MESSAGE)
