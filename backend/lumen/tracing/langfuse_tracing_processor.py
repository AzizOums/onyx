...
from lumen.tracing.flows import IMAGE_FLOWS
from lumen.tracing.framework.processor_interface import TracingProcessor
from lumen.tracing.framework.span_data import (
    AgentSpanData,
    FunctionSpanData,
    GenerationSpanData,
    SpanData,
...
from lumen.tracing.incognito import suppresses_external_traces
...
class LangfuseTracingProcessor(TracingProcessor):
    ...
    def _propagated(attributes: dict[str, Any] | None) -> AbstractContextManager[Any]:
        ...
        Re-applied per observation, not held open for the trace: Lumen links
