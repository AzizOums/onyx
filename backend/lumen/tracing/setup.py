...
from lumen.configs.app_configs import USER_USAGE_TRACKING_ENABLED
from lumen.tracing.dynamic_processor import DynamicTracingProcessor
from lumen.tracing.framework import add_trace_processor, set_trace_processors
...
def _setup_user_usage_tracking() -> None:
    ...
    from lumen.tracing.processors.user_usage_processor import UserUsageTracingProcessor
