...
from lumen.chat.citation_processor import CitationMapping, DynamicCitationProcessor
...
from lumen.db.tools import get_tool_by_name
...
from lumen.prompts.deep_research.orchestration_layer import (
...
from lumen.tools.fake_tools.research_agent import run_research_agent_calls
from lumen.tools.interface import Tool
from lumen.tools.models import ToolCallInfo, ToolCallKickoff
...
from lumen.tracing.framework.create import ChatTraceMetadata, function_span, trace
...
def run_deep_research_llm_loop(
    ...
    with trace(
        ...
        from lumen.llm.litellm_singleton.config import initialize_litellm
