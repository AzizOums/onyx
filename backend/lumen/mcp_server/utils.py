"""Utility helpers for the Lumen MCP server."""
...
async def get_indexed_sources(
    ...
    try:
        ...
        logger.error(
            "Lumen MCP Server: Failed to fetch indexed sources",
            exc_info=True,
        )
        raise
        ...
        logger.error(
            "Lumen MCP Server: Unexpected error fetching indexed sources",
            exc_info=True,
        )
...
async def get_accessible_document_sets(
    ...
    try:
        ...
        logger.error(
            "Lumen MCP Server: Failed to fetch document sets",
            exc_info=True,
        )
        raise
    except Exception as exc:
        logger.error(
            "Lumen MCP Server: Unexpected error fetching document sets",
            exc_info=True,
        )
...
async def get_accessible_agents(
    ...
    try:
        ...
        logger.error(
            "Lumen MCP Server: Failed to fetch agents",
            exc_info=True,
        )
        raise
    except Exception as exc:
        logger.error(
            "Lumen MCP Server: Unexpected error fetching agents",
            exc_info=True,
        )
