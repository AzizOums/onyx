...
from lumen.llm.models import AnyThinkingBlock, RedactedThinkingBlock, ThinkingBlock
...
def from_litellm_model_response_stream(
    ...
    """
    Convert a LiteLLM ModelResponseStream into the simplified Lumen representation.
    """
...
def from_litellm_model_response(
    ...
    """
    Convert a LiteLLM ModelResponse into the simplified Lumen representation.
    """
    response_data = response.model_dump()
