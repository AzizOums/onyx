...
from lumen.db.models import Persona, SearchSettings, User
from lumen.llm.constants import LlmProviderNames
from lumen.llm.interfaces import LLM, LlmRequestPolicy
from lumen.llm.models import ReasoningEffort, UserChatDefaults
...
from lumen.utils.headers import build_llm_extra_headers
...
def _build_provider_extra_headers(
    ...
    # Passing these will put Lumen on the OpenRouter leaderboard
