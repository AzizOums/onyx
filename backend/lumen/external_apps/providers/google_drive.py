...
from lumen.external_apps.providers.google_base import GoogleOAuthProvider
...
# Lumen created or the user opened with it) with the Docs, Sheets, and Slides
...
class GoogleDriveProvider(GoogleOAuthProvider, LumenManagedExtApp):
