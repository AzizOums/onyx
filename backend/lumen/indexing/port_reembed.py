...
from lumen.indexing.chunker import (
    MAX_METADATA_PERCENTAGE,
    get_metadata_suffix_for_document_index,
)
from lumen.indexing.embedder import IndexingEmbedder
from lumen.indexing.models import DocAwareChunk, IndexChunk
...
def _augmentation_reembed(
    ...
    if future_rag_on:
        ...
        from lumen.indexing.indexing_pipeline import add_contextual_summaries
