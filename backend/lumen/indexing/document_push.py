...
- the EE DOCUMENT_PUSH hook (lumen/hooks/points/document_push.py), managed via
...
from lumen.utils.external_endpoint import ExternalEndpointConfig, post_json_to_endpoint
...
class DocumentPushPayload(BaseModel):
    ...
    source: str = Field(
        description=(
            ...
            "Full list: https://github.com/lumen-dot-app/lumen/blob/main/backend/lumen/configs/constants.py#L195"
        )
    )
    url: str | None = Field(
