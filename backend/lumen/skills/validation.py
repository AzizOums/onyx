...
from lumen.skills.models import SKILL_NAME_PATTERN
...
def validate_stored_custom_skill(
    ...
    except (LumenError, KeyError, zipfile.BadZipFile) as exc:
        detail = exc.detail if isinstance(exc, LumenError) else str(exc)
        return SkillValidationResult(
            is_valid=False,
            normalized_bundle=None,
