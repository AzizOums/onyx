...
- ``ExternalAppBuiltInProvider``: a built-in skill backed by a connectable
  ...
  (``lumen.db.external_app.create_external_app``).
...
from lumen.image_gen.generation import is_image_generation_configured
from lumen.server.features.build.configs import ENABLE_BROWSER
