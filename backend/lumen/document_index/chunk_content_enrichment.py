from lumen.configs.app_configs import BLURB_SIZE
from lumen.configs.constants import RETURN_SEPARATOR
from lumen.context.search.models import InferenceChunk, InferenceChunkUncleaned
...
def cleanup_content_for_chunks(
    ...
    def _remove_title(chunk: InferenceChunkUncleaned) -> str:
        ...
        # backend/lumen/document_index/vespa/vespa_document_index.py but I don't
        ...
        # from title_prefix.
        # This was added in
        # https://github.com/lumen-dot-app/lumen/commit/e90c66c1b61c5b7da949652d703f7c906863e6e4#diff-2a2a29d5929de75cdaea77867a397934d9f8b785ce40a861c0d704033e3663ab,
        # see postprocessing.py. At that time the content enrichment logic was
        # also added in that commit, see
        # https://github.com/lumen-dot-app/lumen/commit/e90c66c1b61c5b7da949652d703f7c906863e6e4#diff-d807718aa263a15c1d991a4ab063c360c8419eaad210b4ba70e1e9f47d2aa6d2R77
        # chunker.py.
