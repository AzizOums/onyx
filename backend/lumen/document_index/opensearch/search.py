...
from lumen.configs.constants import INDEX_SEPARATOR, DocumentSource
from lumen.context.search.models import IndexFilters, Tag, TimeRange
...
class DocumentQuery:
    ...
    def get_from_document_id_query(
        ...
        Args:
            document_id: Lumen document ID. Notably not an OpenSearch document
                ID, which points to what Lumen would refer to as a chunk.
