...
from lumen.configs.app_configs import MAX_CONSECUTIVE_PORT_FAILURES_BEFORE_PAUSE
from lumen.db.connector_credential_pair import (
    fetch_indexable_standard_connector_credential_pair_ids,
)
from lumen.db.enums import IndexModelStatus, PortAttemptStatus, SwitchoverType
from lumen.db.models import ConnectorCredentialPair, PortAttempt, SearchSettings, User
from lumen.db.user_file import fetch_port_scope_user_ids
...
def resume_paused_port_attempt(
    ...
    *,
    ...
    from lumen.db.port_orphan_candidate import port_target_settings_id
