...
from lumen.configs.constants import DEFAULT_BOOST, DocumentSource
from lumen.configs.kg_configs import KG_SIMPLE_ANSWER_MAX_DISPLAYED_SOURCES
from lumen.db.chunk import delete_chunk_stats_by_connector_credential_pair__no_commit
from lumen.db.connector_credential_pair import get_connector_credential_pair_from_id
from lumen.db.document_access import apply_document_access_filter
from lumen.db.entities import (
...
from lumen.db.feedback import delete_document_feedback_for_documents__no_commit
from lumen.db.index_attempt_metrics import safe_record_single_event_if_set
...
from lumen.db.relationships import (
    delete_from_kg_relationships__no_commit,
    delete_from_kg_relationships_extraction_staging__no_commit,
)
from lumen.db.tag import delete_document_tags_for_documents__no_commit
from lumen.db.utils import DocumentRow, SortOrder, model_to_dict
from lumen.document_index.document_metadata import DocumentMetadata
from lumen.file_store.staging import delete_files_best_effort
...
def get_access_info_for_documents(
    ...
    - List of emails of Lumen users with direct access to the doc (includes a "None" element if
