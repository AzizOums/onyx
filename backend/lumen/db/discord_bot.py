...
from lumen.auth.api_key import build_displayable_api_key, generate_api_key, hash_api_key
from lumen.configs.constants import DISCORD_SERVICE_API_KEY_NAME
from lumen.db.api_key import insert_api_key
...
from lumen.db.users import delete_user_from_db__no_commit
...
def get_or_create_discord_service_api_key(
    ...
    Lumen API pods when sending chat requests.
