...
from lumen.db.models import Project__UserFile, User, UserFile, UserProject
from lumen.server.documents.connector import upload_files
from lumen.server.features.projects.projects_file_utils import (
    RejectedFile,
...
def upload_files_to_user_files_with_indexing(
    ...
    if DISABLE_VECTOR_DB and background_tasks is not None:
        from lumen.background.task_utils import drain_processing_loop
