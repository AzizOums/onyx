...
from lumen.db.models import Hook, HookExecutionLog
...
def create_hook__no_commit(
    *,
    ...
    LumenError(CONFLICT) if a hook already exists, including under concurrent
...
def update_hook__no_commit(
    *,
    ...
    if hook is None:
        raise LumenError(LumenErrorCode.NOT_FOUND, f"Hook with id {hook_id} not found.")
