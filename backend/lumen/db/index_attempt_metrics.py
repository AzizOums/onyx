...
``lumen.db.index_attempt_metrics_models`` so that ``lumen.db.models`` can
...
from lumen.db.models import IndexAttemptStageMetric
...
def get_stage_metrics_for_attempt(
    ...
    """
    # Imported here to avoid a circular dependency: ``lumen.db.models`` imports
