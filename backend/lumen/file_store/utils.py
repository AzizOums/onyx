...
from lumen.file_store.models import ChatFileType, FileDescriptor, InMemoryChatFile
from lumen.server.query_and_chat.chat_utils import mime_type_to_chat_file_type
from lumen.utils.b64 import get_image_type
...
def verify_user_files(
    ...
    """
    from lumen.db.models import Project__UserFile
