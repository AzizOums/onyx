...
from lumen.db.models import FileRecord
from lumen.db.models import FileRecord as FileStoreModel
from lumen.file_store.s3_key_utils import generate_s3_key
from lumen.utils.file import FileWithMimeType
...
class S3BackedFileStore(FileStore):
    ...
    def __init__(
        ...
        self._s3_prefix = s3_prefix or "lumen-files"
...
def get_default_file_store() -> FileStore:
    ...
    """
    from lumen.configs.app_configs import FILE_STORE_BACKEND
    from lumen.configs.constants import FileStoreType
