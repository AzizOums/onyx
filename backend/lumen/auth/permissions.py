...
from lumen.db.enums import AccountType, Permission, PermissionAuthority
from lumen.db.models import User
from lumen.db.permissions import parse_permission_values
...
PERMISSION_REGISTRY: list[PermissionRegistryEntry] = [
    ...
    PermissionRegistryEntry(
        ...
        description="Add and update Lumen integrations with Slack or Discord.",
...
def require_permission(
    ...
    *,
    ...
    from lumen.auth.users import current_chat_accessible_user, current_user
