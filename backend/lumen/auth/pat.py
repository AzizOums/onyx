...
from lumen.auth.constants import PAT_LENGTH, PAT_PREFIX
from lumen.auth.utils import get_hashed_bearer_token_from_request
...
def build_displayable_pat(token: str) -> str:
    ...
    Example: lumen_pat_abc1****xyz9
    """
    # Show first 12 chars (lumen_pat_ + 4 random chars) and last 4 chars
