...
from lumen.voice.interface import VoiceProviderInterface
...
def get_voice_provider(provider: VoiceProvider) -> VoiceProviderInterface:
    ...
    if provider_type == "openai":
        from lumen.voice.providers.openai import OpenAIVoiceProvider
        ...
        from lumen.voice.providers.azure import AzureVoiceProvider
        ...
        from lumen.voice.providers.elevenlabs import ElevenLabsVoiceProvider
