"""
Standardized error codes for the Lumen backend.

Usage:
    from lumen.error_handling.error_codes import LumenErrorCode
    from lumen.error_handling.exceptions import LumenError

    raise LumenError(LumenErrorCode.UNAUTHENTICATED, "Token expired")
"""

from enum import Enum


class LumenErrorCode(Enum):
    """
    ...
    # Session rejection reasons (see lumen/auth/session_tokens.py); 403 so the
    ...
    @classmethod
    def for_status(cls, status_code: int) -> "LumenErrorCode":
        ...
        gives those responses the same code vocabulary as ``LumenError``.
        """
...
_CANONICAL_CODE_FOR_STATUS: dict[int, LumenErrorCode] = {
    400: LumenErrorCode.BAD_REQUEST,
    401: LumenErrorCode.UNAUTHENTICATED,
    403: LumenErrorCode.UNAUTHORIZED,
    404: LumenErrorCode.NOT_FOUND,
    409: LumenErrorCode.CONFLICT,
    413: LumenErrorCode.PAYLOAD_TOO_LARGE,
    422: LumenErrorCode.VALIDATION_ERROR,
    429: LumenErrorCode.RATE_LIMITED,
    500: LumenErrorCode.INTERNAL_ERROR,
    501: LumenErrorCode.NOT_IMPLEMENTED,
    502: LumenErrorCode.BAD_GATEWAY,
    503: LumenErrorCode.SERVICE_UNAVAILABLE,
    504: LumenErrorCode.GATEWAY_TIMEOUT,
}
