...
from lumen.db.models import SlackChannelConfig
from lumen.lumenbot.slack.models import SlackMessageInfo
from lumen.utils.logger import LumenLoggingAdapter, setup_logger
...
def handle_standard_answers(
    ...
    versioned_handle_standard_answers = fetch_versioned_implementation(
        "lumen.lumenbot.slack.handlers.handle_standard_answers",
...
def _handle_standard_answers(
    ...
    logger: LumenLoggingAdapter,  # noqa: ARG001
