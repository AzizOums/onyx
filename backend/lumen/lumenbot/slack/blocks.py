...
from lumen.configs.constants import DocumentSource, SearchFeedbackType
from lumen.configs.lumenbot_configs import LUMEN_BOT_NUM_DOCS_TO_DISPLAY
from lumen.context.search.models import SearchDoc
from lumen.db.chat import get_chat_session_by_message_id
from lumen.db.engine.sql_engine import get_session_with_current_tenant
from lumen.db.models import ChannelConfig
...
from lumen.lumenbot.slack.icons import source_to_github_img_link
from lumen.lumenbot.slack.models import (
...
def _build_sources_blocks(
    ...
    num_docs_to_display: int = LUMEN_BOT_NUM_DOCS_TO_DISPLAY,
) -> list[Block]:
...
def build_slack_response_blocks(
    ...
    """
    # If called with the LumenBot slash command, the question is lost so we have to reshow it
