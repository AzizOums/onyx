...
from lumen.db.models import DiscordChannelConfig, DiscordGuildConfig
from lumen.lumenbot.discord.api_client import LumenAPIClient
from lumen.lumenbot.discord.constants import (
    MAX_CONTEXT_MESSAGES,
    MAX_MESSAGE_LENGTH,
    THINKING_EMOJI,
)
from lumen.lumenbot.discord.exceptions import APIError
...
def _format_messages_as_context(
    ...
    for msg in messages:
        ...
        sender = (
            "LumenBot" if msg.author.id == bot_user.id else f"@{msg.author.display_name}"
        )
    ...
    return (
        "You are a Discord bot named LumenBot.\n"
...
async def send_response(
    ...
    if isinstance(message.channel, discord.Thread):
        ...
        thread_name = f"LumenBot <> {message.author.display_name}"[:100]
...
async def send_error_response(
    ...
    error_msg = "Sorry, I encountered an error processing your message. You may want to contact Lumen for support :sweat_smile:"
