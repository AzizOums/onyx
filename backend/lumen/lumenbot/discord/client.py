...
from lumen.lumenbot.discord.constants import CACHE_REFRESH_INTERVAL
from lumen.lumenbot.discord.handle_commands import (
    handle_dm,
    handle_registration_command,
    handle_sync_channels_command,
)
from lumen.lumenbot.discord.handle_message import process_chat_message, should_respond
...
class LumenDiscordClient(commands.Bot):
    ...
    def __init__(self, command_prefix: str = DISCORD_BOT_INVOKE_CHAR) -> None:
        ...
        self.api_client = LumenAPIClient()
...
def main() -> None:
    ...
    logger.info("Starting Lumen Discord Bot...")
