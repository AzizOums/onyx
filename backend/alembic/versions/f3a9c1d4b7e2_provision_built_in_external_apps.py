"""Provision Lumen-managed built-in external apps for existing tenants (cloud only)
...
# Frozen snapshot of the Lumen-managed built-in app catalog. Every managed app
...
_BUILT_IN_APPS: list[dict] = [
    {
        ...
        "name": "Slack",
        "description": (
            "Read your Slack messages and channels as context inside Lumen Craft."
        ),
    ...
    },
    {
        ...
        "description": (
            "Read and create events on your Google Calendar from inside Lumen Craft."
        ),
