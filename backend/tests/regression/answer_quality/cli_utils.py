...
def start_docker_compose(
    ...
    command = (
        f"docker compose -f docker-compose.search-testing.yml -p lumen-{env_name} up -d"
    )
    command += " --build"
...
if __name__ == "__main__":
    ...
    If no environment_name is indicated, will just clean up all lumen docker containers/volumes/networks
