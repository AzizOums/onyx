"""External dependency tests for lumen.file_store.staging.
...
from lumen.db.file_record import delete_filerecord_by_file_id, get_filerecord_by_file_id
from lumen.file_store.file_store import get_default_file_store
from lumen.file_store.staging import build_raw_file_callback, stage_raw_file
