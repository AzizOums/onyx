...
from lumen.connectors.sharepoint.connector import SharepointAuthMethod
...
def sharepoint_test_env_setup() -> Generator[SharepointTestEnvSetupTuple]:
    ...
    admin_email = "admin@lumen.app"
    user1_email = "subash@lumen.app"
    user2_email = "raunak@lumen.app"
