...
from lumen.file_processing.image_summarization import (
    _summarize_image,
...
class TestUnsupportedMimeTypeLogging:
    ...
    @patch(
        "lumen.file_processing.image_summarization.summarize_image_pipeline",
        side_effect=__import__(
            "lumen.file_processing.image_summarization",
    ...
    def test_logs_magic_bytes_and_size(
        ...
        with patch("lumen.file_processing.image_summarization.logger") as mock_logger:
