...
def _kill_live_children():
    ...
    from lumen.utils.os_reaper import _live_child_pids, reap_exited_children
...
from lumen.utils.os_reaper import become_child_subreaper, reap_exited_children
...
from lumen.utils.os_reaper import (
    _live_child_pids,
...
def test_reap_exited_children_noop_without_children() -> None:
    ...
    harness = (
        "from lumen.utils.os_reaper import reap_exited_children\n"
