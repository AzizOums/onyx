...
Run with: mypy tests/unit/lumen/utils/test_sensitive_typing.py --ignore-missing-imports
...
def demonstrate_incorrect_usage() -> None:
    ...
    from lumen.utils.sensitive import SensitiveValue
    from lumen.utils.encryption import encrypt_string_to_bytes, decrypt_bytes_to_string
