...
from lumen.prompts.constants import REMINDER_TAG_DESCRIPTION
from lumen.prompts.prompt_utils import (
...
def test_frontend_placeholder_catalog_matches_backend_allowlist() -> None:
    ...
    from lumen.prompts.prompt_utils import USER_PLACEHOLDER_KEYS
...
@patch(
    "lumen.prompts.prompt_utils.get_current_llm_day_time",
