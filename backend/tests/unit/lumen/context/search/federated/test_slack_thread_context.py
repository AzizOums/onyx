...
from lumen.context.search.federated.models import SlackMessage
from lumen.context.search.federated.slack_search import (
    SlackRateLimitError,
    ThreadContextResult,
...
class TestFetchThreadContext:
    ...
    @patch("lumen.context.search.federated.slack_search.batch_get_user_profiles")
    @patch("lumen.context.search.federated.slack_search.WebClient")
...
class TestFetchThreadContextsWithRateLimitHandling:
    ...
    @patch("lumen.context.search.federated.slack_search._fetch_thread_context")
    @patch(
        "lumen.context.search.federated.slack_search.run_functions_tuples_in_parallel"
    )
