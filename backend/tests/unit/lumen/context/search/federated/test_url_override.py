...
from lumen.context.search.federated.models import DirectThreadFetch
from lumen.context.search.federated.slack_search import _fetch_thread_from_url
from lumen.context.search.federated.slack_search_utils import extract_slack_message_urls
...
class TestFetchThreadFromUrl:
    ...
    @patch("lumen.context.search.federated.slack_search._build_thread_text")
