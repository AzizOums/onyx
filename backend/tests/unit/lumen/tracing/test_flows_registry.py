"""Unit tests for ``lumen.tracing.flows`` and ``traced_llm_call``."""

import pytest

from lumen.tracing.flows import IMAGE_FLOWS, LLMFlow
from lumen.tracing.framework.create import trace
