...
from lumen.chat.prompt_utils import build_system_prompt
from lumen.db.memory import UserInfo, UserMemoryContext
...
def test_organization_profile_block_renders_fields() -> None:
    ...
    with patch("lumen.chat.prompt_utils.get_company_context", return_value=None):
