...
from lumen.chat import llm_step as llm_step_module
...
from lumen.llm.interfaces import LLMConfig, ToolChoiceOptions
...
from lumen.prompts.chat_prompts import IMAGE_DROP_REMINDER
...
<parameter name="queries" string="false">["Lumen documentation", "Lumen docs", "Lumen platform"]</parameter>
</invoke>
</function_calls>
"""
        tool_calls = extract_tool_calls_from_response_text(
        ...
        assert tool_calls[0].tool_args == {
            "queries": ["Lumen documentation", "Lumen docs", "Lumen platform"]
        }
...
<parameter name="queries" string="false">["Lumen docs"]</parameter>
</invoke>
</function_calls>
"""
        tool_calls = extract_tool_calls_from_response_text(
...
class TestXmlToolCallContentFilter:
    ...
    def test_strips_function_calls_block_split_across_chunks(self) -> None:
        ...
        chunks = [
            ...
            '<parameter name="queries" string="false">["Lumen docs"]',
...
class TestEmptyAnswerRecovery:
    ...
    def _content_stream(chunks: list[str]) -> Any:
        from lumen.llm.model_response import Delta, ModelResponseStream, StreamingChoice
    ...
    def _run(
        ...
        *,
        ...
        from lumen.chat import llm_step as _llm_step_module
        from lumen.chat.citation_processor import CitationMode, DynamicCitationProcessor
        from lumen.chat.llm_step import run_llm_step_pkt_generator
