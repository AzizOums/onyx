...
from lumen.chat.models import ChatLoadedFile
...
from lumen.prompts.chat_prompts import TOOL_CALL_RESPONSE_CROSS_MESSAGE
...
class TestGetOrExtractPlaintext:
    ...
    def test_cache_hit_skips_extraction(self) -> None:
        ...
        with (
            patch(
                "lumen.chat.chat_utils.get_default_file_store",
                return_value=file_store,
            ),
            patch("lumen.chat.chat_utils.store_plaintext") as store_plaintext,
        ):
