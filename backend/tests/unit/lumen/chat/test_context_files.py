...
class TestResolveContextUserFiles:
    ...
    @patch("lumen.chat.process_message.get_user_files_from_project")
...
class TestExtractContextFiles:
    ...
    @patch("lumen.chat.process_message.load_in_memory_chat_files")
    ...
    def test_tool_metadata_file_id_matches_chat_history_file_id(
        ...
        from lumen.chat.chat_utils import build_file_context
    ...
    @patch("lumen.chat.process_message.DISABLE_VECTOR_DB", True)
