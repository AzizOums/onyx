...
from lumen.tools.models import ToolCallException, WebSearchToolOverrideKwargs
from lumen.tools.tool_implementations.web_search.models import WebSearchResult
from lumen.tools.tool_implementations.web_search.web_search_tool import (
    WebSearchTool,
...
def _make_tool(mock_provider: Any) -> WebSearchTool:
    ...
    with (
        patch(
            "lumen.tools.tool_implementations.web_search.web_search_tool.get_session_with_current_tenant"
        ) as mock_session_ctx,
        patch(
            "lumen.tools.tool_implementations.web_search.web_search_tool.fetch_active_web_search_provider",
            return_value=provider_model,
        ),
        patch(
            "lumen.tools.tool_implementations.web_search.web_search_tool.build_search_provider_from_config",
