...
from lumen.tools.tool_implementations.open_url.models import FailedFetch
from lumen.tools.tool_implementations.open_url.lumen_web_crawler import FailureReason
...
# ---------------------------------------------------------------------------
# CF challenge body detector — used by the LumenWebCrawler fallback to decide
...
def test_looks_like_cloudflare_challenge_detects_script_src() -> None:
    from lumen.utils.playwright_fetch import looks_like_cloudflare_challenge
