...
from lumen.tools.models import DynamicSchemaInfo, ToolResponse
...
class TestCustomTool(unittest.TestCase):
    ...
    @patch("lumen.tools.tool_implementations.custom.custom_tool.requests.request")
    ...
    def test_custom_tool_user_placeholders(
        ...
        tools = build_custom_tools_from_openapi_schema_and_headers(
            ...
            custom_headers=[
                {"key": "X-Lumen-User-Id", "value": "USER_ID"},
                {
                    "key": "X-Lumen-User-Email",  # pragma: allowlist secret
                    "value": "USER_EMAIL",
                },
            ],
