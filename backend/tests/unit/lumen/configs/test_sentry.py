...
import lumen.configs.sentry as sentry_module
from lumen.configs.sentry import _add_instance_tags
...
class TestAddInstanceTags:
    ...
    @patch("lumen.utils.telemetry.get_or_generate_uuid", return_value="test-uuid-1234")
    ...
    @patch(
        "lumen.utils.telemetry.get_or_generate_uuid",
