...
from lumen.file_store.utils import load_user_file, store_plaintext

_UTILS_MODULE = "lumen.file_store.utils"
...
def test_store_plaintext_persists_empty_content(
    ...
    extraction. See _get_or_extract_plaintext in lumen/chat/chat_utils.py.
    """
    file_store = MagicMock()
    mock_get_file_store.return_value = file_store
