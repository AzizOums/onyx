...
from lumen.connectors.models import Document, DocumentSource, TextSection
...
def _run_adapter_build(
    ...
    with (
        patch(
            "lumen.indexing.adapters.user_file_indexing_adapter.fetch_user_project_ids_for_user_files",
            return_value=project_ids_map,
        ),
        patch(
            "lumen.indexing.adapters.user_file_indexing_adapter.fetch_persona_ids_for_user_files",
            return_value=persona_ids_map,
        ),
        patch(
            "lumen.indexing.adapters.user_file_indexing_adapter.get_access_for_user_files",
            return_value={file_id: _make_access()},
        ),
        patch(
            "lumen.indexing.adapters.user_file_indexing_adapter.fetch_chunk_counts_for_user_files",
