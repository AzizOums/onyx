...
from lumen.connectors.models import Section, TabularSection
from lumen.indexing.chunking.section_chunker import AccumulatorState
from lumen.indexing.chunking.tabular_section_chunker import TabularChunker
from lumen.indexing.chunking.tabular_section_chunker.analysis import analyze_sheet
from lumen.indexing.chunking.tabular_section_chunker.sheet_descriptor import (
    build_sheet_descriptor_chunks,
)
from lumen.indexing.chunking.tabular_section_chunker.total_descriptor import (
    TOTALS_HEADER,
    build_total_descriptor_chunks,
)
from lumen.natural_language_processing.utils import BaseTokenizer
from lumen.utils.csv_utils import parse_csv_string, read_csv_header
...
def _fake_tabular_file_store(monkeypatch: pytest.MonkeyPatch) -> Iterator[None]:
    import lumen.indexing.chunking.tabular_section_chunker.tabular_section_chunker as mod
