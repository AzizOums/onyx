...
from lumen.db.llm import sync_model_configurations
from lumen.server.manage.llm.models import SyncModelEntry
...
class TestSyncModelConfigurations:
    ...
    def test_inserts_new_models(self) -> None:
        ...
        with patch(
            "lumen.db.llm.fetch_existing_llm_provider_by_id", return_value=mock_provider
        ):
            models = [
                SyncModelEntry(
                    name="gpt-4",
    ...
    def test_raises_on_missing_provider(self) -> None:
        ...
        with patch("lumen.db.llm.fetch_existing_llm_provider_by_id", return_value=None):
