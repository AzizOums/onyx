...
from lumen.db.projects import upload_files_to_user_files_with_indexing
...
@patch("lumen.db.projects.get_current_tenant_id", return_value="test_tenant")
@patch("lumen.db.projects.create_user_files")
@patch(
    "lumen.background.celery.versioned_apps.client.app",
