...
from lumen.db.enums import PatType
from lumen.db.models import User
from lumen.db.pat import PatAuthResult
...
async def test_pat_type_selects_credential_type(
    ...
    assert request.state.usage_credential == UsageCredentialIdentity(
        expected_credential_type, "7", "my-token", "lumen_pat_...abcd"
    )
