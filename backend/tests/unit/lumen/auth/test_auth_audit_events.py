...
pattern). Emission itself is covered in tests/unit/lumen/utils/test_audit.py.
"""
...
@pytest.mark.asyncio
@patch("lumen.auth.users.mt_cloud_identify_user")
...
@pytest.mark.asyncio
@patch("lumen.auth.users.send_forgot_password_email")
@patch("lumen.auth.users.fetch_ee_implementation_or_noop")
@patch("lumen.auth.users.EMAIL_CONFIGURED", True)
...
@pytest.mark.asyncio
@patch("lumen.auth.users.send_user_verification_email")
