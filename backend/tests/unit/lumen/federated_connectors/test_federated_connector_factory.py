...
from lumen.federated_connectors.factory import (
...
from lumen.federated_connectors.registry import (
...
class TestFederatedConnectorMappingValidation:
    ...
    def test_mapping_format_consistency(self) -> None:
        ...
        for source, mapping in FEDERATED_CONNECTOR_CLASS_MAP.items():
            ...
            assert mapping.module_path.startswith("lumen.federated_connectors."), (
                f"{source.value} module_path doesn't start with lumen.federated_connectors."
            )
...
class TestFederatedConnectorClassLoading:
    ...
    def test_load_federated_connector_class_import_error(
        ...
        assert (
            "Failed to import SlackFederatedConnector from lumen.federated_connectors.slack.federated_connector"
