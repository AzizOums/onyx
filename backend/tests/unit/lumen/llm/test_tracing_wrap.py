# ruff: noqa: ARG002
"""Unit tests for `lumen.llm.tracing_wrap`.
...
from lumen.llm.interfaces import LLM, LLMConfig, LLMUserIdentity
...
from lumen.llm.tracing_wrap import (
...
from lumen.tracing.framework.create import generation_span, trace
...
def test_stream_records_usage_when_consumer_abandons_generator() -> None:
    ...
    llm = _UsageStreamLLM()
    with patch("lumen.tracing.llm_utils.record_llm_span_output") as recorder:
        gen = cast(
