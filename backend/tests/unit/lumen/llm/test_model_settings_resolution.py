...
from lumen.llm.models import ReasoningEffort, UserMessage, resolve_reasoning_effort
...
def _sent_kwargs(llm: LitellmLLM, effort: ReasoningEffort) -> dict[str, Any]:
    ...
    with patch("lumen.llm.litellm_singleton.litellm.completion", side_effect=completion):
        llm._completion(
...
class TestUpsertValidation:
    """Rejections happen at the API boundary, via LumenError."""
