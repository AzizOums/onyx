"""Unit tests for `lumen.llm.utils` helpers that must consider a custom
...
from lumen.llm.utils import model_needs_formatting_reenabled, model_supports_image_input
