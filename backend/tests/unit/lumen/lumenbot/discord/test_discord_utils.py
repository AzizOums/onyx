...
class TestGetBotToken:
    ...
    def test_get_token_from_env(self) -> None:
        ...
        with patch("lumen.lumenbot.discord.utils.DISCORD_BOT_TOKEN", "env_token_123"):
    ...
    def test_get_token_from_db(self) -> None:
        ...
        with (
            patch("lumen.lumenbot.discord.utils.DISCORD_BOT_TOKEN", None),
            patch("lumen.lumenbot.discord.utils.MULTI_TENANT", False),  # Not cloud
            patch("lumen.lumenbot.discord.utils.get_session_with_tenant") as mock_session,
            patch(
                "lumen.lumenbot.discord.utils.get_discord_bot_config",
    ...
    def test_get_token_env_priority(self) -> None:
        ...
        with (
            patch("lumen.lumenbot.discord.utils.DISCORD_BOT_TOKEN", "env_token_123"),
            patch(
                "lumen.lumenbot.discord.utils.get_discord_bot_config",
                return_value=mock_config,
            ),
