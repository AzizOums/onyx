...
from lumen.lumenbot.discord.constants import MAX_CONTEXT_MESSAGES
...
from tests.unit.lumen.lumenbot.discord.conftest import AsyncIteratorMock, mock_message
...
class TestContextFormatting:
    ...
    def test_context_format_bot_marker(self, mock_bot_user: MagicMock) -> None:
        """Bot messages in context are marked as LumenBot:."""
        msg = mock_message(
            content="Bot response",
            author_bot=True,
            author_id=mock_bot_user.id,
