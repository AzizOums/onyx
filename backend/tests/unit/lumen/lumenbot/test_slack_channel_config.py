...
from lumen.db.slack_channel_config import create_slack_channel_persona
...
def test_create_slack_channel_persona_reuses_existing_persona() -> None:
    ...
    with (
        patch(
            "lumen.db.slack_channel_config.get_builtin_tool",
            return_value=fake_tool,
        ),
        patch("lumen.db.slack_channel_config.upsert_persona") as mock_upsert,
    ):
