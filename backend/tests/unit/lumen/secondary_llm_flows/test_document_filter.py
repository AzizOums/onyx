...
from lumen.llm.multi_llm import LLMTimeoutError
...
@patch("lumen.secondary_llm_flows.document_filter.record_llm_response")
@patch(
    "lumen.secondary_llm_flows.document_filter.llm_generation_span",
