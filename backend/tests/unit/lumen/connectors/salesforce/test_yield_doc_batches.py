...
from lumen.connectors.salesforce.connector import (
    SalesforceConnector,
...
class TestYieldDocBatches:
    ...
    def mock_sf_db(self) -> MagicMock:
        """Create a mock LumenSalesforceSQLite object."""
        return MagicMock()
    ...
    @patch("lumen.connectors.salesforce.connector.convert_sf_object_to_doc")
