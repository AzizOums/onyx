...
from lumen.connectors.clickup.connector import CLICKUP_API_BASE_URL, ClickupConnector
...
def test_get_all_tasks_filtered_uses_relative_endpoint() -> None:
    ...
    with patch("lumen.connectors.clickup.connector.requests.get") as mock_get:
