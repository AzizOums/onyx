...
@patch("lumen.connectors.discord.connector.Client.close", new_callable=AsyncMock)
@patch("lumen.connectors.discord.connector.Client.login", new_callable=AsyncMock)
...
@patch("lumen.connectors.discord.connector.Client.close", new_callable=AsyncMock)
@patch(
    "lumen.connectors.discord.connector.Client.login",
