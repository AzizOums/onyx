...
from lumen.connectors.web.connector import (
...
def test_colliding_rewritten_ids_emit_only_first_document() -> None:
    ...
    with (
        patch(
            "lumen.connectors.web.connector.ScrapeSessionContext.initialize",
        ),
        patch("lumen.connectors.web.connector.check_internet_connection"),
        patch("lumen.connectors.web.connector.protected_url_check"),
