...
from lumen.connectors.models import ConnectorFailure, Document, DocumentFailure
...
def _fetch_with_pagination_error(
    ...
    fake_client = mock.Mock(spec=LumenConfluence)
    ...
    with (
        ...
        mock.patch(
            "lumen.connectors.confluence.connector.convert_attachment_to_content",
