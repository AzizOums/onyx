...
from lumen.connectors.confluence import lumen_confluence as lumen_confluence_module
from lumen.connectors.confluence.lumen_confluence import (
...
@pytest.fixture
def confluence_server_client(mock_credentials_provider: mock.Mock) -> LumenConfluence:
    confluence = LumenConfluence(
        is_cloud=False,
...
def test_cql_paginate_all_expansions_handles_internal_pagination_error(
    confluence_server_client: LumenConfluence, caplog: pytest.LogCaptureFixture
) -> None:
    """
...
def test_paginated_cql_retrieval_cloud_reduces_limit_on_error(
    ...
    """
    confluence_cloud_client = LumenConfluence(
        is_cloud=True,
...
def test_paginate_url_reduces_limit_on_500_server(
    confluence_server_client: LumenConfluence,
) -> None:
    """
...
def test_get_user_email_from_userkey_caches_lookups(
    ...
    lumen_confluence_module._USER_KEY_TO_EMAIL_CACHE.clear()
