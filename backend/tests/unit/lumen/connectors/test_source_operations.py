...
from lumen.connectors import source_operations as source_operations_module
from lumen.connectors.capability_checks.models import CredentialCapability
...
def _static_provider() -> LumenStaticCredentialsProvider:
    """Builds a throwaway credentials provider for gateway construction."""
    return LumenStaticCredentialsProvider(None, "test", {})
...
def test_private_helpers_and_data_attrs_are_allowed() -> None:
    ...
    class _TidyOperations(SourceOperations):
        source = DocumentSource.SLACK
        sdk_modules = ()
        docs_link = "https://docs.lumen.app/connectors/slack"
