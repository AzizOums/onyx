...
from lumen.connectors.google_drive.models import DriveRetrievalStage

_FILE_RETRIEVAL_MODULE = "lumen.connectors.google_drive.file_retrieval"
...
def test_resource_key_download_uses_header() -> None:
    ...
    with patch(
        "lumen.connectors.google_drive.doc_conversion._download_request",
