...
from lumen.connectors.models import ExternalAccess
from lumen.connectors.sharepoint.connector import (
    SharepointConnector,
    _convert_sitepage_to_document,
    _convert_sitepage_to_slim_document,
)
from lumen.connectors.sharepoint.connector_utils import SharepointPermissionCache
...
@patch("lumen.connectors.sharepoint.connector.get_sharepoint_external_access")
...
@patch("lumen.connectors.sharepoint.connector._convert_sitepage_to_slim_document")
@patch(
    "lumen.connectors.sharepoint.connector.SharepointConnector._create_rest_client_context"
)
@patch("lumen.connectors.sharepoint.connector.SharepointConnector._fetch_site_pages")
@patch("lumen.connectors.sharepoint.connector.SharepointConnector._fetch_driveitems")
@patch("lumen.connectors.sharepoint.connector.SharepointConnector.fetch_sites")
...
def test_retrieve_all_slim_docs_does_not_fetch_permissions(
    ...
    from lumen.connectors.models import ExternalAccess, SlimDocument
    from lumen.connectors.sharepoint.connector import DriveItemData
...
@patch("lumen.connectors.sharepoint.connector.requests.get")
@patch("lumen.connectors.sharepoint.connector.acquire_token_for_rest")
...
def test_probe_role_assignments_caps_probed_sites(
    ...
    from lumen.connectors.sharepoint.connector import ROLE_ASSIGNMENTS_PROBE_MAX_SITES
...
@patch("lumen.connectors.sharepoint.connector.requests.get")
@patch(
    "lumen.connectors.sharepoint.connector.SharepointConnector._get_graph_access_token"
)
