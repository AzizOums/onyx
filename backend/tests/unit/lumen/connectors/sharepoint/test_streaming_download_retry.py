...
from lumen.connectors.sharepoint import connector as sp_connector
...
@patch("lumen.connectors.sharepoint.connector.time")
...
@patch("lumen.connectors.sharepoint.connector.time")
@patch("lumen.connectors.sharepoint.connector.logger")
@patch("lumen.connectors.sharepoint.connector.requests.get")
