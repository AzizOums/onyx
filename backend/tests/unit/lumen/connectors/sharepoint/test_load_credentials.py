...
from lumen.connectors.sharepoint.connector import SharepointConnector
...
@patch("lumen.connectors.sharepoint.connector.msal.ConfidentialClientApplication")
@patch("lumen.connectors.sharepoint.connector.GraphClient")
...
@patch("lumen.connectors.sharepoint.connector.load_certificate_from_pfx")
@patch("lumen.connectors.sharepoint.connector.msal.ConfidentialClientApplication")
@patch("lumen.connectors.sharepoint.connector.GraphClient")
