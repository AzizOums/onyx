...
from lumen.connectors.asana.asana_api import AsanaAPI
from lumen.connectors.asana.connector import AsanaConnector
...
def _build_api_with_mocks(
    ...
    *,
    ...
    """
    with patch("lumen.connectors.asana.asana_api.asana"):
