...
from lumen.connectors.capability_checks.registry import get_capability_checks
from lumen.connectors.capability_checks.runner import run_capability_checks
...
from lumen.connectors.slack.capability_checks import (
