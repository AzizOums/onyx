...
def test_zendesk_client_per_minute_rate_limiting(
    ...
    import lumen.connectors.cross_connector_utils.rate_limit_wrapper as rlw
    import lumen.connectors.zendesk.connector as zendesk_mod
    from lumen.connectors.zendesk.connector import ZendeskClient
