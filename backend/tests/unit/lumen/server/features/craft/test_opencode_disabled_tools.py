...
the PostHog `lumen-craft-opencode-disabled-tools` multivariate flag, keyed on
...
from lumen.feature_flags.interface import FeatureFlagProvider, NoOpFeatureFlagProvider
...
def test_none_variant_disables_nothing(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert provider.calls == [("lumen-craft-opencode-disabled-tools", "tenant_dev")]
