...
from lumen.server.features.build.sandbox.event_schema import PromptResponse
...
from lumen.server.features.build.timeouts import PROMPT_SLOT_KEEP_ALIVE_MAX_SECONDS
