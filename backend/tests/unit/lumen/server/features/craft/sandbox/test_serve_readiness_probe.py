...
from lumen.server.features.build.sandbox.opencode.serve_client import OpencodeServeClient
...
_SERVICE_URL = "http://sandbox-x.lumen-sandboxes.svc.cluster.local:4096"
_PASSWORD = "hunter2"
