"""Unit tests for :mod:`lumen.server.features.build.sandbox.opencode.event_bus`.
...
from lumen.server.features.build.sandbox.opencode import event_bus as event_bus_mod
