...
from lumen.db.models import ModelCostOverride
from lumen.error_handling.exceptions import register_lumen_exception_handlers
from lumen.llm import cost_overrides
from lumen.llm.cost_overrides import delete_override, list_overrides, upsert_override
...
def test_writes_invalidate_cache(
    ...
    calls: list[int] = []
    monkeypatch.setattr(
        "lumen.server.features.usage.api.invalidate_override_cache",
