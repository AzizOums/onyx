...
from lumen.server.auth_check import PUBLIC_ENDPOINT_SPECS, is_route_in_spec_list
from lumen.server.features.mcp import client_metadata

TEST_WEB_DOMAIN = "https://lumen.example.com"
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "https://lumen.example.com/api/mcp/oauth/client-metadata",
        ),
