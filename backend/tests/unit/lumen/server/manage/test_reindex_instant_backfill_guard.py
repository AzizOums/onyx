...
from lumen.context.search.models import SearchSettingsCreationRequest
...
from lumen.server.manage.search_settings import set_new_search_settings

_MODULE = "lumen.server.manage.search_settings"
