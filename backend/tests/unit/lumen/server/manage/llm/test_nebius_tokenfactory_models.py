...
Lumen model configs: context length and vision (from architecture.modality).
"""
...
from lumen.server.manage.llm.api import get_nebius_tokenfactory_available_models
from lumen.server.manage.llm.models import NebiusTokenfactoryModelsRequest
...
def _fetch(sample: dict | None = None) -> dict:
    with (
        patch("lumen.server.manage.llm.api._resolve_api_key", return_value="k"),
        patch(
            "lumen.server.manage.llm.api._get_nebius_tokenfactory_models_response",
