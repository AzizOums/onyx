...
from lumen.server.query_and_chat.chat_backend import update_chat_session_reasoning
from lumen.server.query_and_chat.models import UpdateChatSessionReasoningRequest
...
def _setup(
    ...
    monkeypatch.setattr(
        "lumen.server.query_and_chat.chat_backend.get_chat_session_by_id",
...
def test_update_chat_session_reasoning_rejects_invalid_values(
    ...
    assert exc.value.error_code is LumenErrorCode.INVALID_INPUT
