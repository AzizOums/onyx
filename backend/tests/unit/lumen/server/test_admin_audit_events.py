...
tests/unit/lumen/utils/test_audit.py.
"""
...
from lumen.server.api_key.api import (
    create_api_key,
    delete_api_key,
    regenerate_existing_api_key,
    update_existing_api_key,
)
from lumen.server.manage.llm.api import delete_llm_provider
from tests.utils.audit import audit_events


@patch("lumen.server.api_key.api.insert_api_key")
...
@patch("lumen.server.api_key.api.regenerate_api_key")
...
@patch("lumen.server.api_key.api.update_api_key")
...
@patch("lumen.server.api_key.api.remove_api_key")
...
@patch("lumen.server.manage.llm.api.invalidate_provider_listing_cache")
@patch("lumen.server.manage.llm.api.remove_llm_provider")
