...
from lumen.background.celery.tasks.hierarchyfetching.tasks import (
    _connector_supports_hierarchy_fetching,
    check_for_hierarchy_fetching,
)
from lumen.connectors.factory import ConnectorMissingException
...
TASKS_MODULE = "lumen.background.celery.tasks.hierarchyfetching.tasks"
