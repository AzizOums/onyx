...
``lumen.background.celery.apps.app_base.on_setup_logging``:
...
import lumen.utils.logger as logger_module
from lumen.background.celery.apps import app_base
from lumen.utils.logger import THIRD_PARTY_CAPPED_LOGGER_NAMES
