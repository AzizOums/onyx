...
from lumen.connectors.jira.connector import JiraConnector
...
def _test_jira_connector_basic(jira_connector: JiraConnector) -> None:
    ...
    assert story.metadata == {
        ...
        "reporter_email": "chris@lumen.app",
        "assignee_email": "chris@lumen.app",
    ...
    assert (
        section.text
        == "This is a critical request for super-human answer quality in Lumen! We need magic!\n"
    )
    ...
    assert epic.metadata == {
        "priority": "Medium",
        "status": "Backlog",
        "reporter": "Founder Lumen",
        "assignee": "Chris Weaver",
        "issuetype": "Epic",
        "created": "2025-04-16T16:55:53.068-0700",
        "reporter_email": "founders@lumen.app",
        "assignee_email": "chris@lumen.app",
        "project_name": "DailyConnectorTestProject",
        "project": "AS",
        "key": "AS-4",
