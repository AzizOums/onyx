...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function handleFinish() {
    const domain = domainInput.value.trim() || DEFAULT_LUMEN_DOMAIN;
    const useLumenAsDefault = useLumenAsDefaultToggle.checked;
    ...
    chrome.storage.local.get(
      {
        ...
        [CHROME_SPECIFIC_STORAGE_KEYS.USE_LUMEN_AS_DEFAULT_NEW_TAB]: true,
      },
      (result) => {
        if (result[CHROME_SPECIFIC_STORAGE_KEYS.LUMEN_DOMAIN]) {
