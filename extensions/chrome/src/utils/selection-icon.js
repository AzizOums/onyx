(function () {
  ...
  function createSelectionIcon() {
    ...
    selectionIcon.id = "lumen-selection-icon";

    const img = document.createElement("img");
    img.src = chrome.runtime.getURL("public/icon32.png");
    img.alt = "Search with Lumen";
  ...
  document.addEventListener("mouseup", (e) => {
    if (
      e.target.id === "lumen-selection-icon" ||
      e.target.closest("#lumen-selection-icon")
    ) {
      return;
    }
