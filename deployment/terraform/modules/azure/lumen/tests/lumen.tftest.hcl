...
run "both_account_names_keep_the_whole_digest" {
  ...
  # global namespace.
  variables {
    name = "lumen-enterprise-production-deployment"
  }
...
run "an_explicit_storage_account_name_is_used_as_given" {
  ...
  variables {
    storage_account_name = "lumenfilesprod"
  }

  assert {
    condition     = local.storage_account_name == "lumenfilesprod"
...
run "the_resource_group_is_created_by_default" {
  ...
  assert {
    condition     = local.resource_group_name_desired == "lumen-default"
...
run "a_supplied_network_falls_back_to_load_balancer_egress" {
  ...
  variables {
    ...
    virtual_network_id         = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/lumen-rg/providers/Microsoft.Network/virtualNetworks/existing"
    aks_subnet_id              = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/lumen-rg/providers/Microsoft.Network/virtualNetworks/existing/subnets/aks"
    postgres_subnet_id         = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/lumen-rg/providers/Microsoft.Network/virtualNetworks/existing/subnets/postgres"
    private_endpoint_subnet_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/lumen-rg/providers/Microsoft.Network/virtualNetworks/existing/subnets/pe"
  }
...
run "entra_only_needs_no_password" {
  ...
  variables {
    ...
    database_administrator_principal_name = "lumen-db-admins"
  }
...
run "no_managed_redis_by_default" {
  ...
  # Lumen can run on Managed Redis, but only on database 0 and only on the
