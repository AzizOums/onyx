variable "name" {
  type        = string
  description = "Name prefix for every resource. Example: \"lumen\"."
  default     = "lumen"
}
...
variable "storage_container_name" {
  type        = string
  description = "Blob container holding the Lumen file store"
  default     = "lumen-file-store"
}
...
variable "additional_workload_service_account_names" {
  type        = list(string)
  description = "Further service accounts in the Lumen namespace that may use the workload identity. Use the rendered name for chart-created workloads such as lumen-sandbox-proxy."
  default     = []
}
