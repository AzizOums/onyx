...
page_title: "lumen_settings Data Source - terraform-provider-lumen"
subcategory: ""
description: |-
  The current Lumen workspace settings, read-only. Useful for referencing settings (e.g. the license tier) without managing them.
---

# lumen_settings (Data Source)
