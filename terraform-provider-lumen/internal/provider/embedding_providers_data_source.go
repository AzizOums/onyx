...
// NewEmbeddingProvidersDataSource returns the lumen_embedding_providers data source.
...
func (d *embeddingProvidersDataSource) Read(ctx context.Context, _ datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Failed to list Lumen embedding providers", err.Error())
		return
	}
