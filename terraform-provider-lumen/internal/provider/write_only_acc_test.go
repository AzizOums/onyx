...
func TestAccLLMProviderWriteOnlyAPIKey(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
resource "lumen_llm_provider" "wo" {
...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrSet("lumen_llm_provider.wo", "id"),
					// The point of the feature: neither the write-only value nor
					// the stored twin is in state.
					resource.TestCheckNoResourceAttr("lumen_llm_provider.wo", "api_key"),
					resource.TestCheckNoResourceAttr("lumen_llm_provider.wo", "api_key_wo"),
					// The rotation counter is stored, which is what makes a
					// diff possible at all.
					resource.TestCheckResourceAttr("lumen_llm_provider.wo", "api_key_wo_version", "1"),
				),
			},
			{
...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("lumen_llm_provider.wo", "api_key_wo_version", "2"),
					resource.TestCheckNoResourceAttr("lumen_llm_provider.wo", "api_key"),
				),
			},
		},
...
func TestAccLLMProviderRejectsBothAPIKeyForms(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
resource "lumen_llm_provider" "conflict" {
...
func TestAccEmbeddingProviderWriteOnlyAPIKey(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
resource "lumen_embedding_provider" "wo" {
...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("lumen_embedding_provider.wo", "id", "voyage"),
					resource.TestCheckNoResourceAttr("lumen_embedding_provider.wo", "api_key"),
					resource.TestCheckNoResourceAttr("lumen_embedding_provider.wo", "api_key_wo"),
				),
			},
		},
	})
...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("lumen_credential.wo", "name", "tf-acc-credential-wo"),
					resource.TestCheckNoResourceAttr("lumen_credential.wo", "credential_json"),
					resource.TestCheckNoResourceAttr("lumen_credential.wo", "credential_json_wo"),
				),
			},
			{
...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("lumen_credential.wo", "name", "tf-acc-credential-wo-renamed"),
					resource.TestCheckNoResourceAttr("lumen_credential.wo", "credential_json"),
				),
			},
			{
...
`,
				Check: resource.TestCheckResourceAttr("lumen_credential.wo", "credential_json_wo_version", "2"),
			},
		},
	})
}
...
func TestAccCredentialRequiresExactlyOnePayloadForm(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
resource "lumen_credential" "missing" {
  source = "confluence"
...
func TestAccCredentialRejectsBothPayloadForms(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
resource "lumen_credential" "both" {
  source             = "confluence"
...
`, name, mcpServerURL),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("lumen_mcp_server.wo", "name", name),
					resource.TestCheckResourceAttr("lumen_mcp_server.wo", "auth_type", "API_TOKEN"),
					resource.TestCheckNoResourceAttr("lumen_mcp_server.wo", "api_token"),
					resource.TestCheckNoResourceAttr("lumen_mcp_server.wo", "api_token_wo"),
				),
			},
		},
	})
...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckNoResourceAttr("lumen_custom_tool.wo", "custom_headers"),
					resource.TestCheckNoResourceAttr("lumen_custom_tool.wo", "custom_headers_wo"),
					// Lumen hands header values back in full, so this is a real
					// end-to-end check that the secret arrived.
					testAccCheckCustomToolHeader(t, "lumen_custom_tool.wo", "X-Api-Key", "tf-acc-write-only-header"),
				),
			},
			{
				// The refresh is where a write-only header map could leak:
				// Lumen returns the value, and without the private-state marker
...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckNoResourceAttr("lumen_custom_tool.wo", "custom_headers"),
					testAccCheckCustomToolHeader(t, "lumen_custom_tool.wo", "X-Api-Key", "tf-acc-write-only-header-rotated"),
				),
			},
		},
	})
...
func TestAccCustomToolWriteOnlyHeadersRejectConflictingAuth(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
resource "lumen_custom_tool" "conflict_wo" {
...
// testAccCheckCustomToolHeader reads the header back from Lumen, which masks
