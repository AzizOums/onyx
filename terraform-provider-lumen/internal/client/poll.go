...
// Defaults for the convergence polls. Several Lumen writes only schedule work
...
func (e *TimeoutError) Error() string {
	...
	return msg + ". The operation runs in the background and may still finish; " +
		"check the Lumen admin panel, and raise the timeout if this deployment is slow"
}
