...
// Inline `@import "@lumen-ai/shared/*.css"` by splicing in the resolved file's
// contents, so the published opal artifact is SELF-CONTAINED and has no runtime
// dependency on @lumen-ai/shared. Opal still consumes shared as the build-time
