...
A living catalog for browsing, testing, and documenting Lumen UI components in isolation.

---

## What is this?

This Storybook contains interactive examples of every reusable UI component in the Lumen frontend. Each component has a dedicated page with:
...
Production builds deploy to [lumen-storybook.vercel.app](https://lumen-storybook.vercel.app) automatically when PRs touching component files merge to `main`.
