...
interface NRFPreferencesContextValue {
  useLumenAsNewTab: boolean;
  setUseLumenAsNewTab: (v: boolean) => void;
}
...
export function NRFPreferencesProvider({
  ...
  const [useLumenAsNewTab, setUseLumenAsNewTab] = useLocalStorageState<boolean>(
    LocalStorageKeys.USE_LUMEN_AS_NEW_TAB,
    true
  );
