...
export const Default: Story = {
  args: {
    href: "https://docs.lumen.app",
    children: "Lumen Documentation",
  },
};

export const CustomClassName: Story = {
  args: {
    href: "https://github.com/lumen-dot-app/lumen",
...
export const InContext: Story = {
  render: () => (
    <p className="font-main-content-body text-text-04">
      ...
      <InlineExternalLink href="https://docs.lumen.app">
        official documentation
      </InlineExternalLink>{" "}
      or check out the{" "}
      <InlineExternalLink href="https://github.com/lumen-dot-app/lumen">
        source code
      </InlineExternalLink>
      .
    </p>
