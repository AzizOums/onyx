...
export interface MinimalLumenDocument {
  document_id: string;
  semantic_identifier: string | null;
}

export interface LumenDocument extends MinimalLumenDocument {
  link: string;
  source_type: ValidSources;
  blurb: string;
  boost: number;
...
export interface LoadedLumenDocument extends LumenDocument {
  icon: React.FC<{ size?: number; className?: string }>;
}

export interface SearchLumenDocument extends LumenDocument {
  is_relevant: boolean;
  relevance_explanation: string;
}

export interface FilteredLumenDocument extends LumenDocument {
  included: boolean;
}
...
export interface SearchResponse {
  ...
  answer: string | null;
  quotes: Quote[] | null;
  documents: SearchLumenDocument[] | null;
...
export interface SearchRequestArgs {
  ...
  updateDocs: (documents: LumenDocument[]) => void;
 ...
 * Matches backend/lumen/context/search/models.py BaseFilters
 */
